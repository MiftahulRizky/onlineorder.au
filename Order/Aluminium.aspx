<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Aluminium.aspx.vb" Inherits="Order_Aluminium" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Aluminium Order" %>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <label class="col-lg-3 col-form-label">ALUMINIUM TYPE</label>
                            ...
                            <div runat="server" id="divDetail">
                                ...
                                <div class="mb-6 row" runat="server">
                                    ...
                                    <div class="col-lg-2 col-md-12 col-sm-12" runat="server">
                                        ...
                                        <small class="form-hint">* Wand Length</small>
                                    </div>
                                    <div class="col-lg-2 col-md-12 col-sm-12">
                                ...
                                <div class="mb-3 row" runat="server" id="divHoldDown">

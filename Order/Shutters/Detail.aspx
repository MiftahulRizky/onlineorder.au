...
Inherits="Order_Detail" MasterPageFile="~/Site.Master"
MaintainScrollPositionOnPostback="true" Debug="true" Title="Detail Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div class="row g-2 align-items-center">
        ...
        <div class="col-lg-8 col-sm-12 col-md-12 text-end">
          ...
          <a
            ...
            data-bs-toggle="modal"
            data-bs-target="#modalSubmitOrder"
            >Submit</a
          >
          <a
            runat="server"
            ...
            href="#canvasOtorisasi"
            role="button"
            aria-controls="canvasAdd"
          >
            Authorization
            <span
              runat="server"
              id="spanOtorisasi"
              class="badge bg-red text-blue-fg badge-notification badge-pill"
              >0</span
            ></a
          >
          <button
          ...
          <div class="dropdown-menu dropdown-menu-end">
            <a
              ...
              class="dropdown-item"
              data-bs-toggle="modal"
              data-bs-target="#modalAuthorizeOrder"
              >Authorize Order</a
            >
            <a
              href="#"
              ...
              class="dropdown-item"
              data-bs-toggle="modal"
              data-bs-target="#modalDeclineOrder"
              >Decline Order</a
            >
          </div>
          <a
            ...
            class="btn btn-info"
            data-bs-toggle="modal"
            data-bs-target="#modalGenerateJob"
            >Generate Job</a
          >
          <a
            href="#"
            ...
            class="btn btn-info"
            data-bs-toggle="modal"
            data-bs-target="#modalUnsubmitOrder"
            >Unsubmit</a
          >
          <a
            href="#"
          ...
          <a
            ...
            data-bs-toggle="modal"
            data-bs-target="#modalCompleteOrder"
            >Complete</a
          >
          <a
            href="#"
          ...
          <div class="dropdown-menu dropdown-menu-end">
            <a
              ...
              class="dropdown-item"
              data-bs-toggle="modal"
              data-bs-target="#modalQuoteDetail"
              >Quote Details</a
            >
            <asp:Button
              runat="server"
              ...
              Text="Download Quote"
              OnClick="btnQuoteDownload_Click"
              OnClientClick="return showWaitingQuote();"
            />
          </div>
          <button
          ...
          <div class="dropdown-menu dropdown-menu-end">
            <a
              href="#"
              runat="server"
              id="aStatusAdditional"
              class="dropdown-item"
              data-bs-toggle="modal"
              data-bs-target="#modalStatusAdditional"
              >Additional Status</a
            >
            <a
              href="#"
            ...
            <a
              ...
              class="dropdown-item"
              data-bs-toggle="modal"
              data-bs-target="#modalQuoteEmail"
              >Email Quote</a
            >
            <div
              class="dropdown-divider"
              runat="server"
              id="divDividerDeposit"
            ></div>
            <a
              href="#"
              runat="server"
          ...
          <div class="card">
            ...
            <div class="table-responsive">
              <asp:GridView
                runat="server"
                ID="gvList"
                CssClass="table table-vcenter table-striped table-hover card-table"
                AutoGenerateColumns="false"
                AllowPaging="true"
                ShowHeaderWhenEmpty="true"
                PagerSettings-Position="Top"
                EmptyDataText="ORDER ITEM NOT FOUND"
              ...
              >
                ...
                <Columns>
                  ...
                  <asp:TemplateField ItemStyle-Width="150px">
                    <ItemTemplate>
                      <button
                        class="btn btn-sm btn-pill btn-orange"
                        data-bs-toggle="dropdown"
                      >
                        Actions
                      </button>
                      <div class="dropdown-menu dropdown-menu-end">
                        <asp:LinkButton
                          ...
                          Visible='<%# VisibleDetail(Eval("ProductId").ToString())%>'
                        ></asp:LinkButton>
                        ...
                        <asp:LinkButton
                          ...
                          CommandName="Copy"
                          CommandArgument='<%# Eval("Id") %>'
                          Visible='<%# VisibleCopy(Eval("ProductId").ToString())%>'
                        ></asp:LinkButton>
                        ...
                        <a
                          ...
                          onclick='<%# String.Format("return showDelete(`{0}`, `{1}`, `{2}`);", Eval("Id").ToString(), Eval("Number").ToString(), "Detail") %>'
                          visible='<%# VisibleDelete(Eval("ProductId").ToString()) %>'
                          >Delete</a
                        >
                        ...
                        <div
                          class="dropdown-divider"
                          runat="server"
                          visible='<%# VisibleProduction(Eval("ProductId").ToString(), Eval("Production").ToString()) %>'
                        ></div>
                        <a
                          href="#"
                          runat="server"
                          ...
                          onclick='<%# String.Format("return showProduction(`{0}`, `{1}`);", Eval("Id").ToString(), Eval("Production").ToString()) %>'
                          visible='<%# VisibleProduction(Eval("ProductId").ToString(), Eval("Production").ToString()) %>'
                          >Change Production</a
                        >
                        <%--END PRODUCTION--%> <%--START PRICING--%>
            ...
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitOrder"
                  CssClass="btn w-100 btn-success"
                  Text="Confirm"
                  OnClick="btnSubmitOrder_Click"
                  OnClientClick="return showWaiting();"
                />
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center py-4">
          ...
          <div
            ...
            runat="server"
            id="divMinimumSurcharge"
          >
            <b>This is a minimum surcharge customer.</b><br />
            Please make sure you have added the minimum additional charge to
            this order.
          </div>
          ...
          <div class="w-100">
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitGenerateJob"
                  CssClass="btn w-100 btn-info"
                  Text="Confirm"
                  OnClick="btnSubmitGenerateJob_Click"
                  OnClientClick="return showWaiting();"
                />
              </div>
            </div>
          ...
          <div class="w-100">
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitUnsubmit"
                  CssClass="btn w-100 btn-info"
                  Text="Confirm"
                  OnClick="btnSubmitUnsubmit_Click"
                />
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center py-4">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon mb-2 text-orange icon-lg"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <path d="M8 9h8" />
            <path d="M8 13h6" />
            ...
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  ...
                  CssClass="btn w-100 btn-orange"
                  Text="Confirm"
                  OnClick="btnSubmitComplete_Click"
                  OnClientClick="return showWaiting();"
                />
              </div>
            </div>
          ...
          <div class="row mb-3">
            <div class="col-6">
              ...
              <small class="form-hint"
                >* Please use decimal separator with dot (.)</small
              >
            </div>
            <div class="col-6">
          ...
          <div class="row mb-4">
            <div class="col-6">
              ...
              <div class="input-group">
                ...
                <asp:TextBox
                  runat="server"
                  ID="txtQuoteCheckMeasure"
                  CssClass="form-control"
                  placeholder="Check Measure ..."
                  autocomplete="off"
                ></asp:TextBox>
              </div>
              <small class="form-hint"
          ...
          <div class="w-33">
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitQuoteDetail"
                  CssClass="btn btn-primary w-100"
                  Text="Submit"
                  OnClick="btnSubmitQuoteDetail_Click"
                  OnClientClick="return showWaiting();"
                />
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center py-4">
          ...
          <div class="text-secondary">
            Are you sure you would like to do this?
            <br /><br />
            There is no success message if successful. Please check Exact
            directly.
          </div>
        </div>
        <div class="modal-footer">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center py-4">
          ...
          <div class="text-secondary">
            Are you sure you would like to do this?
            <br /><br />
            There is no success message if successful. Please check Micronet
            directly.
          </div>
        </div>
        <div class="modal-footer">
  ...
  >
    ...
    <div class="offcanvas-body">
      <asp:ListView
        runat="server"
        ID="lvOtorisasi"
        OnItemCommand="lvOtorisasi_ItemCommand"
      >
        <ItemTemplate>
          <div class="row row-cards mb-3">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-actions">
                    <asp:Button
                      ...
                      Visible='<%# VisibleAuthorizeDeclineListView(Eval("Status").ToString()) %>'
                    ...
                    <asp:Button
                      ...
                      Text="Reset"
                      CssClass="btn"
                      Visible='<%# VisibleResetListView(Eval("Status").ToString()) %>'
                      CommandName="Reset"
                      CommandArgument='<%# Eval("Id").ToString() %>'
                    />
                  </div>
                ...
                <div class="card-body">
                  <h5 class="card-title">
                    Order# <%# Eval("JobOtorisasi").ToString() %>
                  </h5>
                  <span>- <%# Eval("Description").ToString() %></span>

                  <span
                    runat="server"
                    class="<%# BindStyleAuthorization(Eval(&quot;Status&quot;).ToString()) %>"
                    ><%# BindTextAuthorization(Eval("Status").ToString(),
                    Eval("LoginId").ToString()) %></span
                  >
                </div>
              </div>
            </div>
          ...
          <div class="w-100">
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitAuthorizeOrder"
                  CssClass="btn btn-info w-100"
                  Text="Confirm"
                  OnClick="btnSubmitAuthorizeOrder_Click"
                />
              </div>
            </div>
          </div>
          ...
          <div class="w-100">
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitDeclineOrder"
                  CssClass="btn btn-info w-100"
                  Text="Confirm"
                  OnClick="btnSubmitDeclineOrder_Click"
                />
              </div>
            </div>
          </div>
          ...
          <div class="w-100">
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitStatusAdditional"
                  CssClass="btn btn-purple w-100"
                  Text="Submit"
                  OnClick="btnSubmitStatusAdditional_Click"
                />
              </div>
            </div>
          </div>
    ...
    >
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <asp:Button
            runat="server"
            ID="btnSubmitIntenalNote"
            CssClass="btn btn-purple"
            Text="Submit"
            OnClick="btnSubmitIntenalNote_Click"
          />
        </div>
      </div>
    </div>
        ...
        <div class="modal-body">
          ...
          <div class="row mb-3">
            <div class="col-12">
              ...
              ></asp:TextBox>
              <small class="form-hint"
                >This is taken from customers primary contact email address if
                available.</small
              >
            </div>
          </div>
          ...
          <div class="row mb-3">
            <div class="col-12">
              ...
              ></asp:TextBox>
              <small class="form-hint"
                >Will be cc'ed to <b>Customer Service</b> and <b>Accounts</b> by
                default.</small
              >
            </div>
          </div>
          ...
          <div class="w-100">
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitQuoteEmail"
                  CssClass="btn btn-purple w-100"
                  Text="Submit"
                  OnClick="btnSubmitQuoteEmail_Click"
                  OnClientClick="return showWaiting();"
                />
              </div>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <asp:Button
            ...
            CssClass="btn btn-purple"
            Text="Submit"
            OnClick="btnSubmitDeposit_Click"
            OnClientClick="return showWaiting();"
          />
        </div>
      </div>
          ...
          <div class="row mb-3">
            <div class="col-12">
              ...
              <small class="form-hint" style="color: red"
                >* Please select a product then click the submit button</small
              >
            </div>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  ...
                  CssClass="btn btn-primary w-100"
                  Text="Submit"
                  OnClick="btnSubmitAddItem_Click"
                />
              </div>
            </div>
          </div>
          ...
          <div class="w-100">
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitDeleteItem"
                  CssClass="btn btn-danger w-100"
                  Text="Confirm"
                  OnClick="btnSubmitDeleteItem_Click"
                />
              </div>
            </div>
          </div>
          ...
          <div class="w-100">
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitEditPricing"
                  CssClass="btn btn-primary w-100"
                  Text="Submit"
                  OnClick="btnSubmitEditPricing_Click"
                />
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col">
                <asp:Button
                  runat="server"
                  ID="btnSubmitOrion"
                  CssClass="btn btn-orange w-100"
                  Text="Submit"
                  OnClick="btnSubmitOrion_Click"
                />
              </div>
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-center py-4">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="icon mb-2 text-secondary icon-lg"
          >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <path
  ...
  <script type="text/javascript">
    ...
    function showProduction(id, production) {
      ...
      document.getElementById("<%=ddlProduction.ClientID %>").value =
        production;
    }

    function showCanvasOtorisasi() {
      const myOffcanvas = new bootstrap.Offcanvas(
        document.getElementById("canvasOtorisasi"),
      );
      myOffcanvas.show();
    }

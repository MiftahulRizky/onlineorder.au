<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Header.aspx.vb"
Inherits="Order_Header" MaintainScrollPositionOnPostback="true"
MasterPageFile="~/Site.master" Debug="true" Title="Create Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-lg-7 col-md-12 col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                  ...
                  <small class="form-hint" style="color: red"
                    >* Please quote this order number when querying this
                    order</small
                  >
                </div>
              </div>
              ...
              <div class="mb-5 row" runat="server" id="divDelivery">
                <label class="col-lg-3 col-form-label required"
                  >DELIVERY / PICK UP</label
                >
                <div class="col-lg-3 col-md-12 col-sm-12">
                  <asp:DropDownList
                    runat="server"
  ...
  <div runat="server" visible="false">
    ...
    <asp:SqlDataSource
      ...
      InsertCommand="INSERT INTO OrderHeaders(Id, UserId, StoreId, OrderNo, OrderCust, Delivery, Note, QuoteGST, QuoteDisc, QuoteInstall, QuoteMeasure, Status, CreatedDate, Active) VALUES (@Id, @UserId, @StoreId, LTRIM(RTRIM(@OrderNo)), LTRIM(RTRIM(@OrderCust)), @Delivery, @Note, 'Yes', 0, 0, 0,  'Draft', GETDATE(), 1)"
      UpdateCommand="UPDATE OrderHeaders SET UserId=@UserId, StoreId=@StoreId, OrderNo=LTRIM(RTRIM(@OrderNo)), OrderCust=LTRIM(RTRIM(@OrderCust)), Delivery=@Delivery, Note=@Note, Active=1 WHERE Id=@Id"
    >
      <InsertParameters>
        ...
        />
        <asp:ControlParameter
          ControlID="txtOrderNo"
          Name="OrderNo"
          PropertyName="Text"
        />
        <asp:ControlParameter
          ControlID="txtReference"
          Name="OrderCust"
          PropertyName="Text"
        />
        <asp:ControlParameter
          ControlID="lblDelivery"
          Name="Delivery"
          PropertyName="Text"
        />
        <asp:ControlParameter

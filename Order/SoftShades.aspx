<%@ Page Title="Soft Shades" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SoftShades.aspx.vb" Inherits="Order_SoftShades" MaintainScrollPositionOnPostback="true" Debug="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="page-body">
                    ...
                    <div class="card">
                        <form action="javascript:void(0)" method="post" id="formSubmit">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    <label for="blindtype" class="col-lg-3 text-uppercase fw-bold">shade type</label>
                                    <div class="col-lg-4">
                                ...
                                <div class="mb-3 row" id="divTubeType">
                                    <label for="tubetype" class="col-lg-3 text-uppercase fw-bold" id="lblTubeType">shade style</label>
                                    <div class="col-lg-4">
     ...
     <script type="text/javascript">
        let DESIGNIDORI = "DFE0B19A-3592-4C4A-A7B0-2B020A629A9C";
    ...
    <script type="text/javascript" src="/Scripts/Order/SoftShades.js?v=1.0.13"></script>
</asp:Content>

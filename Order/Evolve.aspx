<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Evolve.aspx.vb"
Inherits="Order_Evolve" MasterPageFile="~/Site.Master" Title="Evolve Shutters"
%>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div id="divDetail">
                ...
                <div class="mb-2 mt-5 row" id="divJoinedPanels">
                  <label class="col-lg-3 col-form-label"
                    >CO-JOINED PANELS</label
                  >
                  <div class="col-lg-2 col-md-12 col-sm-12">
                ...
                <div class="mb-2 mt-5 row" id="divHingeColour">
                  <label class="col-lg-3 col-form-label">HINGE COLOUR</label>
                  <div class="col-lg-3 col-md-12 col-sm-12">
                ...
                <div class="mb-2 row" id="divLayoutCodeCustom">
                  <label class="col-lg-3 col-form-label required"
                    >CUSTOM LAYOUT CODE</label
                  >
                  <div class="col-lg-5 col-md-12 col-sm-12">
                    <input
                      type="text"
                    ...
                    <small class="form-hint"
                      >* Custom Layout Code (Layout Other)</small
                    >
                  </div>
                </div>
                ...
                <div class="mb-2 mt-5 row" id="divBuildout">
                  ...
                  <div class="col-lg-3 col-md-12 col-sm-12">
                    <select class="form-select" id="buildout">
                      <option value=""></option>
                      <option value="13mm Buildout">13MM BUILDOUT</option>
                    </select>
                  </div>
                </div>

                <div class="mb-3 mt-6 row" id="divSameSize">
                  <label class="col-lg-3 col-form-label"
                    >SAME SIZE PANELS</label
                  >
                  <div class="col-lg-3 col-md-12 col-sm-12">
                    <div class="input-group">
                      ...
                      <a
                        ...
                        onclick="return showInfo('Same Size Panels');"
                      >
                        ?
                      </a>
                    </div>
                  ...
                  <div class="col-lg-9 col-md-12 col-sm-12">
                    <div class="row mb-2">
                      <div class="col-lg-4 col-md-12 col-sm-12" id="divGap1">
                        <div class="input-group">
                          ...
                          <a
                            ...
                            data-bs-toggle="modal"
                            data-bs-target="#modalInfo"
                            onclick="return showInfo('T-Post Location');"
                          >
                            ?
                          </a>
                        </div>
                        <small class="form-hint"
                          >* Gap / T Post / Corner Post / Bay Post 1</small
                        >
                      </div>
                      ...
                      <div class="col-lg-4 col-md-12 col-sm-12" id="divGap2">
                        ...
                        <small class="form-hint"
                          >* Gap / T Post / Corner Post / Bay Post 2</small
                        >
                      </div>
                      ...
                      <div class="col-lg-4 col-md-12 col-sm-12" id="divGap3">
                        ...
                        <small class="form-hint"
                          >* Gap / T Post / Corner Post / Bay Post 3</small
                        >
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-lg-4 col-md-12 col-sm-12" id="divGap4">
                        ...
                        <small class="form-hint"
                          >* Gap / T Post / Corner Post / Bay Post 4</small
                        >
                      </div>
                      ...
                      <div class="col-lg-4 col-md-12 col-sm-12" id="divGap5">
                        ...
                        <small class="form-hint"
                          >* Gap / T Post / Corner Post / Bay Post 5</small
                        >
                      </div>
                    </div>
                  </div>
                ...
                <div class="mb-2 mt-5 row" id="divHorizontalTPost">
                  <label class="col-lg-3 col-form-label"
                    >HORIZONTAL T-POST</label
                  >
                  <div class="col-lg-3 col-md-12 col-sm-12">
                    <div class="input-group">
                      <input
                        type="number"
                        id="horizontaltpostheight"
                        class="form-control"
                        autocomplete="off"
                        placeholder="..... "
                      />
                  ...
                  >
                    <div class="input-group">
                      ...
                      <a
                        ...
                        data-bs-toggle="modal"
                        data-bs-target="#modalInfo"
                        onclick="return showInfo('Horizontal T-Post');"
                      >
                        ?
                      </a>
                    </div>
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="input-group">
                      ...
                      <a
                        ...
                        data-bs-toggle="modal"
                        data-bs-target="#modalInfo"
                        onclick="return showInfo('Tiltrod Type');"
                      >
                        ?
                      </a>
                    </div>
                ...
                <div class="mb-2 mt-5 row">
                  ...
                  <div class="col-lg-8 col-md-12 col-sm-12">
                    <textarea
                      ...
                      style="resize: none"
                    ></textarea>
                    <span class="form-label-description" id="notescount"
                      >0/1000</span
                    >
                  </div>
                </div>
            ...
            <div class="card-footer text-center">
              <a href="javascript:void(0);" id="submit" class="btn btn-primary"
                >Submit</a
              >
              <a href="javascript:void(0);" id="cancel" class="btn btn-danger"
                >Cancel</a
              >
            </div>
          </div>
  ...
  <script type="text/javascript">
    let designIdOri = "F70CD0D8-06E5-4C99-B8D8-E9506C1A0F12";
  ...
  <script src="../Scripts/Order/Evolve.js?v=<%= DateTime.Now.Ticks %>"></script>
</asp:Content>

...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
                        ...
                        <form action="javascript:void(0)" method="post" id="formSubmit">
                            ...
                            <div class="card-body">
                                ...
                                <div  id="divFormDetail">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="fabrictype" class="col-lg-3 text-uppercase fw-bold">fabric</label>
                                        <div class="col-lg-4 col-md-12 col-sm-12">
    ...
    <script type="text/javascript">
        ...
        let URIMETHOD = "/Methods/Order/Global/PanelGlideMethod.aspx";
    </script>

    <script src="/Scripts/Order/Global/PanelGlides.js?<%= DateTime.Now.Ticks %>"></script>

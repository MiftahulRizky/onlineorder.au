<%@ Page Title="Roller Blinds" Language="VB" MasterPageFile="~/Site.master"
AutoEventWireup="true" CodeFile="RollerBlinds.aspx.vb"
Inherits="Order_RollerBlinds" MaintainScrollPositionOnPostback="true"
Debug="true" %>
                        ...
                        <form action="javascript:void(0)" method="post" id="formSubmit">
                            <div class="card-body">
                                ...
                                <div class="mb-3 row" id="divTubeType">
                                    ...
                                    <div class="col-lg-5">
                                        <select type="text" name="tubetype" id="tubetype" class="form-control"></select>
                                    </div>  
                                </div>
                                ...
                                <div  id="divFormDetail">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-secondary">
                                                            <label class="form-label"id="lblNextDesc"></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="mb-3 row" id="divMounting">
                                        ...
                                        <div class="col-lg-5">
                                            <input type="text" name="mounting" id="mounting" class="form-control">
                                        </div>  
                                    </div>
                                    ...
                                    <div class="mb-3 row" id="divMotorStyle">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <select type="text" name="motorstyle" id="motorstyle" class="form-control"></select>
                                    ...
                                    <div class="mb-3 row" id="divMotorRemote">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <select type="text" name="motorremote" id="motorremote" class="form-control"></select>
                                    ...
                                    <div class="mb-3 row" id="divMotorBattery">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="externalbattery" id="externalbattery" class="form-control"></select>
                                        </div>  
                                    </div>
                                    ...
                                    <div class="mb-3 row" id="divMotorCharger">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="charger" id="charger" class="form-control"></select>
                                        </div>  
                                    </div>
                                    ...
                                    <div class="mb-3 row" id="divCableExitPoint">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="cableexitpoint" id="cableexitpoint" class="form-control"></select>
                                        </div>  
                                    </div>
                                    ...
                                    <div class="mb-3 row" id="divConnector">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="connector" id="connector" class="form-control">
                                                <option value=""></option>
                                    ...
                                    <div class="mb-3 row" id="divRoll">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="roll" id="roll" class="form-control">
                                                <option value=""></option>
                                    ...
                                    <div class="mb-3 row" id="divControlPosition">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="controlposition" id="controlposition" class="form-control">
                                                <option value=""></option>
                                    ...
                                    <div class="mb-3 row" id="divTrim">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <select type="text" name="trim" id="trim" class="form-control"></select>
                                    ...
                                    <div class="mb-3 row" id="divBottomRail">
                                        ...
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <select name="railtype" id="railtype" class="form-control "></select>
                                            <small class="form-hint">* Type</small>
                                        </div>
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="input-group">
                                                <select name="railcolour" id="railcolour" class="form-control "></select>
                                            </div>
                                            <small class="form-hint">* Colour</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row" id="divTubeSize">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <select type="text" name="tubesize" id="tubesize" class="form-control"></select>
                                    ...
                                    <div class="mb-3 row" id="divChildSafe">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="childsafe" id="childsafe" class="form-control"></select>
                                        </div>  
                                    </div>
                                    ...
                                    <div class="mb-3 row" id="divAccessory">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="accessory" id="accessory" class="form-control"></select>
                                        </div>  
                                    </div>
                                    ...
                                    <div class="mb-3 row" id="divExtras">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="extras" id="extras" class="form-control"></select>
                                        </div>  
                                    </div>
                                    ...
                                    <div class="mb-3 row" id="divBracketCover">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="bracketcovers" id="bracketcovers" class="form-control">
                                                <option value=""></option>
                                                <option value="Yes">YES</option>
                                            </select>
                                        </div>  
                                    ...
                                    <div class="mb-3 row" id="divBracketExt">
                                        ...
                                        <div class="col-lg-5">
                                            <select type="text" name="bracketext" id="bracketext" class="form-control">
                                                <option value=""></option>
                                                <option value="Yes">YES</option>
                                            </select>
                                        </div>  

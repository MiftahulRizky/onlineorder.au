<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EvolveParts.aspx.vb"
Inherits="Order_EvolveParts" MasterPageFile="~/Site.Master" Title="Evolve Parts"
%>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="mb-2 row">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <select class="form-select" id="category">
                      ...
                      <option value="Framing | Bi-fold or Sliding">
  ...
  <script
    src="../Scripts/Order/EvolveParts.js?v=<%= DateTime.Now.Ticks %>"
  ></script>
</asp:Content>

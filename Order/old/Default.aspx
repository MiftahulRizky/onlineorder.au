                    ...
                    <div class="card">
                            ...
                            <div class="d-flex">
                                <div class="text-secondary">
                                    <div class="ms-2 d-inline-block">
                                        <asp:DropDownList runat="server" ID="ddlStatus" Width="200px" CssClass="form-select " ToolTip="Status Order" AutoPostBack="true" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div class="ms-auto text-secondary">
                                    <asp:Panel runat="server" DefaultButton="btnSearch">
                                        <div class="ms-2 d-inline-block">
                                            <asp:TextBox runat="server" ID="txtSearch" CssClass="form-control " placeholder="Search Data" autocomplete="off" ToolTip="Search Data Order ....."></asp:TextBox>
                                        </div>
                                        <div class="ms-2 d-inline-block">
                                    ...
                                    <asp:TemplateField HeaderText="ORDER DATE">
                                        <ItemTemplate>
                                            <div class="text-center">
                                                <button type="button" class="btn btn-sm btn-outline-warning" title="Information Order Date" data-bs-toggle="modal" data-bs-target="#modalOrderDate" onclick='<%# String.Format("return showInfo(`{0}`, `{1}`, `{2}`, `{3}`, `{4}`, `{5}`);", Eval("OrderNo"), Eval("OrderCust"), Eval("CreatedDate", "{0: MMMM, dd yyyy}"), Eval("SubmittedDate", "{0: MMMM, dd yyyy}"), Eval("CompletedDate", "{0: MMMM, dd yyyy}"), Eval("CanceledDate", "{0: MMMM, dd yyyy}")) %>'>
                        ...
                        <div class="card-footer">
                            ...
                            <div class="ms-2 d-inline-block" runat="server" id="divStoreType">
                                <asp:DropDownList runat="server" ID="ddlStoreType" Width="150px" CssClass="form-select " AutoPostBack="true" OnSelectedIndexChanged="ddlStoreType_SelectedIndexChanged">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-4">
                        ...
                        <asp:TextBox runat="server" ID="txtCreatedDate" CssClass="form-control " placeholder="Created Date ...." ReadOnly="true"></asp:TextBox>
                    </div>

                    <div class="mb-4">
                        <label class="form-label">2. SUBMITTED DATE :</label>
                        <asp:TextBox runat="server" ID="txtSubmittedDate" CssClass="form-control " placeholder="Submitted Date ...." ReadOnly="true"></asp:TextBox>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">3. COMPLETED DATE :</label>
                        <asp:TextBox runat="server" ID="txtCompletedDate" CssClass="form-control " placeholder="Completed Date ...." ReadOnly="true"></asp:TextBox>
                    </div>

                    <div class="mb-3">
                        <label class="form-label">4. CANCELED DATE :</label>
                        <asp:TextBox runat="server" ID="txtCanceledDate" CssClass="form-control " placeholder="Canceled Date ...." ReadOnly="true"></asp:TextBox>
                    </div>
                </div>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PanoramaParts.aspx.vb" Inherits="Order_PanoramaParts" MasterPageFile="~/Site.Master" Title="Panorama PVC Parts" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <select class="form-select" id="category">
                                            ...
                                            <option value="Magnets and Strikers">MAGNETS & STRIKERS</option>
    ...
    <script src="../Scripts/Order/PanoramaParts.js?v=<%= DateTime.Now.Ticks %>"></script>
</asp:Content>

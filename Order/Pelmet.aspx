<%@ Page Title="Pelmet" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Pelmet.aspx.vb" Inherits="Order_Pelmet" MaintainScrollPositionOnPostback="true" Debug="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
                    ...
                    <div class="card">
                        <form action="javascript:void(0)" method="post" id="formSubmit">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    <label for="blindtype" class="col-lg-3 text-uppercase fw-bold">pelmet type</label>
                                    <div class="col-lg-4">
    ...
    <script type="text/javascript">
        let DESIGNIDORI = "31F39E47-546F-46B6-89FD-CB8BBF019D99";
        ...
        let URIMETHOD = "/Methods/Order/PelmetMethod.aspx";
    </script>

    <script type="text/javascript" src="/Scripts/Order/Pelmet.js?<%= DateTime.Now.Ticks %>"></script>
</asp:Content>

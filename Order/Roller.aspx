<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Roller.aspx.vb"
Inherits="Order_Roller" MaintainScrollPositionOnPostback="true"
MasterPageFile="~/Site.master" Debug="true" Title="Roller Order" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="card-body">
              <div class="mb-3 row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                  <asp:DropDownList
                    ...
                    Font-Bold="true"
                    AutoPostBack="true"
                    OnSelectedIndexChanged="ddlBlindType_SelectedIndexChanged"
                  >
                  </asp:DropDownList>
                </div>
              </div>
              ...
              <div class="mb-3 row" runat="server" id="divBracketType">
                <asp:Label
                  runat="server"
                  ID="lblBracketType"
                  CssClass="col-lg-3 col-form-label"
                  >BRACKET TYPE</asp:Label
                >
                <div class="col-lg-5 col-md-12 col-sm-12">
                  <asp:DropDownList
                    ...
                    Font-Bold="true"
                    AutoPostBack="true"
                    OnSelectedIndexChanged="ddlBracketType_SelectedIndexChanged"
                  >
                  </asp:DropDownList>
                </div>
              </div>
              ...
              <div class="mb-3 row" runat="server" id="divTubeType">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                  <asp:DropDownList
                    ...
                    Font-Bold="true"
                    AutoPostBack="true"
                    OnSelectedIndexChanged="ddlTubeType_SelectedIndexChanged"
                  >
                  </asp:DropDownList>
                </div>
              </div>
              ...
              <div class="mb-3 row" runat="server" id="divColourType">
                ...
                <div class="col-lg-3 col-md-12 col-sm-12">
                  <asp:DropDownList
                    ...
                    Font-Bold="true"
                    AutoPostBack="true"
                    OnSelectedIndexChanged="ddlColourType_SelectedIndexChanged"
                  >
                  </asp:DropDownList>
                </div>
              </div>
              ...
              <div runat="server" id="divDetail">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-lg-2 col-md-12 col-sm-12">
                    <asp:TextBox
                      ...
                      TextMode="Number"
                      ID="txtQty"
                      CssClass="form-control qty"
                      placeholder="Qty ..."
                      autocomplete="off"
                      data-clientid="<%= txtQty.ClientID %>"
                    ></asp:TextBox>
                  </div>
                  <div class="col-lg-2" runat="server" id="divQtyInfo">
                    <a
                      ...
                      href="#canvasInfo"
                      role="button"
                      aria-controls="canvasInfo"
                      onclick="return showInfo('Quantity');"
                      ><i class="bi bi-info-circle me-2"></i>Info</a
                    >
                  </div>
                </div>
                ...
                <div class="mb-3 mt-5 row" runat="server" id="divMotorStyle">
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <asp:DropDownList
                      ...
                      ID="ddlMotorStyle"
                      CssClass="form-select"
                      OnSelectedIndexChanged="ddlMotorStyle_SelectedIndexChanged"
                      AutoPostBack="true"
                    >
                    </asp:DropDownList>
                  </div>
                  <div class="col-lg-2" runat="server" id="divMotorStyleInfo">
                    <a
                      ...
                      role="button"
                      aria-controls="canvasInfo"
                      onclick="return showInfo('Motor Style');"
                      >Info</a
                    >
                  </div>
                </div>
                ...
                <div class="mb-6 row" runat="server" id="divMotorRemote">
                  ...
                  <div class="col-lg-2" runat="server" id="divMotorRemoteInfo">
                    <a
                      ...
                      role="button"
                      aria-controls="canvasInfo"
                      onclick="return showInfo('Motor Remote');"
                      >Info</a
                    >
                  </div>
                </div>
                ...
                <div class="mb-3 row" runat="server" id="divMotorBattery">
                  <label class="col-lg-3 col-form-label">
                    EXTERNAL BATTERY</label
                  >
                  <div class="col-lg-2 col-md-12 col-sm-12">
                    <asp:DropDownList
                      runat="server"
                      ID="ddlExternalBattery"
                      CssClass="form-select"
                    >
                    </asp:DropDownList>
                  </div>
                ...
                <div class="mb-3 row" runat="server" id="divCableExitPoint">
                  <label class="col-lg-3 col-form-label">
                    CABLE EXIT POINT</label
                  >
                  <div class="col-lg-2 col-md-12 col-sm-12">
                    <asp:DropDownList
                      runat="server"
                      ID="ddlCableExitPoint"
                      CssClass="form-select"
                    >
                      <asp:ListItem Value="" Text=""></asp:ListItem>
                ...
                <div
                  class="mb-3 mt-6 row"
                  runat="server"
                  id="divControlPosition"
                >
                  <asp:Label
                    runat="server"
                    ID="lblControlPosition"
                    CssClass="col-lg-3 col-form-label"
                ...
                <div class="mb-3 mt-6 row" runat="server" id="divTrimSkin">
                  ...
                  <div class="col-lg-3 col-md-12 col-sm-12">
                    <asp:DropDownList
                      ...
                      CssClass="form-select "
                      AutoPostBack="true"
                      OnSelectedIndexChanged="ddlTrimSkin_SelectedIndexChanged"
                    >
                    </asp:DropDownList>
                  </div>
                </div>
                ...
                <div class="mb-3 row" runat="server" id="divBottomRail">
                  ...
                  <div class="col-lg-3 col-md-12 col-sm-12">
                    <asp:DropDownList
                      ...
                      CssClass="form-select"
                      AutoPostBack="true"
                      OnSelectedIndexChanged="ddlRailType_SelectedIndexChanged"
                    >
                    </asp:DropDownList>
                ...
                <div class="mb-3 mt-6 row" runat="server" id="divTubeSize">
                  ...
                  >
                    <a
                      ...
                      role="button"
                      aria-controls="canvasInfo"
                      onclick="return showInfo('Tube Size');"
                      ><i class="bi bi-info-circle me-2"></i>Info</a
                    >
                  </div>
                </div>
                ...
                <div class="mb-3 row" runat="server" id="divChildSafe">
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    >
                      <asp:ListItem Value="" Text=""></asp:ListItem>
                      <asp:ListItem
                        Value="Clear Loop (Standard)"
                        Text="CLEAR LOOP (STANDARD)"
                      ></asp:ListItem>
                      <asp:ListItem
                        Value="Black - Deluxe"
                        Text="BLACK - DELUXE"
                      ...
                      ></asp:ListItem>
                      <asp:ListItem
                        Value="Birch White - Deluxe"
                        Text="BIRCH WHITE - DELUXE"
                      ></asp:ListItem>
                      <asp:ListItem
                        Value="White - Deluxe"
                        Text="WHITE - DELUXE"
                ...
                <div class="mb-3 row" runat="server" id="divAccessory">
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    >
                      <asp:ListItem Value="" Text=""></asp:ListItem>
                      <asp:ListItem
                        Value="Crochet Ring Pull"
                        Text="CROCHET RING PULL"
                      ></asp:ListItem>
                      <asp:ListItem
                        Value="Metal Ring Pull"
                        Text="METAL RING PULL"
                      ></asp:ListItem>
                      <asp:ListItem
                        Value="Tassle Pull"
                        Text="TASSLE PULL"
                      ></asp:ListItem>
                      <asp:ListItem
                        Value="Plastic Ring & Tab"
                        Text="PLASTIC RING & TAB"
                      ></asp:ListItem>
                      <asp:ListItem
                        Value="Timber Ring & Tab"
                        Text="TIMBER RING & TAB"
                      ></asp:ListItem>
                      <asp:ListItem
                        Value="Silver Ring"
                        Text="SILVER RING"
                      ...
                      ></asp:ListItem>
                      <asp:ListItem
                        Value="Match Metal Ring"
                        Text="MATCH METAL RING"
                      ></asp:ListItem>
                    </asp:DropDownList>
                  </div>
                </div>
    ...
    <div class="offcanvas-body">
      ...
      <div class="mt-3">
        <button
          ...
          data-bs-dismiss="offcanvas"
        >
          <i class="bi bi-check2-circle me-2" style="font-size: 12pt"></i>Ok. I
          Got It
        </button>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center py-4">
          ...
          <h3>Succedeed</h3>
          <div class="text-secondary">
            This is the <b><span id="spanBlind"></span></b>
            <br />
            from
            <b><span id="spanBlindName"></span></b>-
            <b><span id="spanBracketName"></span></b>
            <br />
            <br />
            Please click the <b>ADD BLIND</b> button that is written in green
            color of the <b>ITEM ID <span id="spanItemId"></span></b>.
          </div>
        </div>
  ...
  <script type="text/javascript">
    ...
    if (btnInfoControlType) {
      btnInfoControlType.addEventListener("click", async (e) => {
        ...
        try {
          ...
          const blind = document.getElementById("<%= ddlBlindType.ClientID %>");
          const blindName = await getItemData(
            `SELECT Name FROM Blinds WHERE Id = '${blind.value}'`,
          );
          ...
          btnInfoControlType.innerHTML = "Info";
        }
      });
    }
    ...
    const getItemData = async (query) => {
      try {
        const response = await fetch(
          `/Methods/Order/DetailMethod.aspx/GetItemData`,
          {
            method: "POST",
    ...
    function showConfirm(itemId, blindNo) {
      ...
      var bracketType = document.getElementById(
        "<%= ddlBracketType.ClientID %>",
      );
      var bracketSelected =
        bracketType.options[bracketType.selectedIndex].innerHTML;
      ...
      document.getElementById("spanBlind").innerHTML =
        blindNoSelected.toUpperCase();
    ...
    function showInfo(Type) {
      ...
      if (Type == "Quantity") {
        ...
        spanInfo = "<br />";
        spanInfo =
          "If you change this MOTOR STYLE then the other motor style will follow this motor style.";
      } else if (Type == "Motor Remote") {
        spanInfo = "If any another blind (Double or linked)";
        spanInfo = "<br />";
        spanInfo =
          "If you change this MOTOR REMOTE then the other motor remote will follow this motor remote.";
      } else if (Type == "Size") {
        var bracketType = document.getElementById(
          "<%= ddlBracketType.ClientID %>",
        );
        var bracketSelected =
          bracketType.options[bracketType.selectedIndex].innerHTML;
        spanInfo =
          "If you change this drop then the previous blind will follow this drop size.";
        if (bracketSelected == "DOUBLE") {
          spanInfo =
            "If you change this size then the previous blind will follow this size.";
        }
        spanInfo += "<br /><br />";
        ...
        spanInfo += "<br /><br />";
        spanInfo +=
          "1. If the width or drop are below 2400 then the tube size uses 40";
        spanInfo += "<br />";
        spanInfo +=
          "2. If the width or drop are more than 2400 then the tube size uses 45";
        spanInfo += "<br />";
        spanInfo +=
          "3. If the width or drop are more than 2600 then the tube size uses 45H";
      }
      document.getElementById("canvasInfoLabel").innerHTML =
        Type + " Information";
  ...
  <div runat="server" visible="False">
    ...
    <asp:SqlDataSource
      ...
      UpdateCommand="UPDATE OrderDetails SET TubeSize=@TubeSize, Mounting=@Mounting, Location=@Location, ChildSafe=@ChildSafe, Accessory=@Accessory, BracketCover=@BracketCover, BracketExtension=@BracketExtension, MotorStyle=@MotorStyle, MarkUp=@MarkUp WHERE UniqueId=@UniqueId AND Active=1"
    >
      <UpdateParameters>
        <asp:ControlParameter
          ControlID="lblUniqueId"
          Name="UniqueId"
          PropertyName="Text"
        />
        <asp:ControlParameter
        ...
        />
        <asp:ControlParameter
          ControlID="ddlMounting"
          Name="Mounting"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="ddlAccessory"
          Name="Accessory"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="ddlTubeSize"
          Name="TubeSize"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="ddlBracketCover"
          Name="BracketCover"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="ddlBracketExt"
          Name="BracketExtension"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="ddlChildSafe"
          Name="ChildSafe"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="ddlMotorStyle"
          Name="MotorStyle"
          PropertyName="SelectedItem.Value"
        />
        <%--
        <asp:ControlParameter
          ControlID="ddlMotorRemote"
          Name="MotorRemote"
          PropertyName="SelectedItem.Value"
        />
        --%>
        <asp:ControlParameter
          ControlID="ddlExternalBattery"
          Name="MotorBattery"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="ddlMotorCharger"
          Name="MotorCharger"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="ddlConnector"
          Name="Connector"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="ddlCableExitPoint"
          Name="CableExitPoint"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
    ...
    <asp:SqlDataSource
      ...
      runat="server"
      ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
      UpdateCommand="UPDATE OrderDetails SET FabricId=@FabricId, PriceGroupId=@PriceGroupId, RollDirection=@RollDirection WHERE BlindNo IN ('Blind 1', 'Blind 2') AND UniqueId=@UniqueId AND Active=1"
    >
      <UpdateParameters>
        <asp:ControlParameter
          ControlID="lblUniqueId"
        ...
        />
        <asp:ControlParameter
          ControlID="ddlFabricColour"
          Name="FabricId"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="lblPriceGroupId"
          Name="PriceGroupId"
          PropertyName="Text"
        />
        <asp:ControlParameter
    ...
    <asp:SqlDataSource
      ...
      runat="server"
      ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
      UpdateCommand="UPDATE OrderDetails SET FabricId=@FabricId, PriceGroupId=@PriceGroupId, RollDirection=@RollDirection WHERE BlindNo IN ('Blind 3', 'Blind 4') AND UniqueId=@UniqueId AND Active=1"
    >
      <UpdateParameters>
        <asp:ControlParameter
          ControlID="lblUniqueId"
    ...
    <asp:SqlDataSource
      ...
      runat="server"
      ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
      UpdateCommand="UPDATE OrderDetails SET FabricId=@FabricId, PriceGroupId=@PriceGroupId WHERE UniqueId=@UniqueId AND Active=1"
    >
      <UpdateParameters>
        <asp:ControlParameter
          ControlID="lblUniqueId"
    ...
    <asp:SqlDataSource
      ...
      runat="server"
      ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
      UpdateCommand="UPDATE OrderDetails SET Width=@Width, [Drop]=@Drop WHERE UniqueId=@UniqueId AND Active=1"
    >
      <UpdateParameters>
        <asp:ControlParameter
          ControlID="lblUniqueId"
    ...
    <asp:SqlDataSource
      ...
      runat="server"
      ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
      UpdateCommand="UPDATE OrderDetails SET [Drop]=@Drop WHERE UniqueId=@UniqueId AND Active=1"
    >
      <UpdateParameters>
        <asp:ControlParameter
          ControlID="lblUniqueId"
    ...
    <asp:SqlDataSource
      ...
      runat="server"
      ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
      UpdateCommand="UPDATE OrderDetails SET RollDirection=@RollDirection WHERE UniqueId=@UniqueId AND Active=1"
    >
      <UpdateParameters>
        <asp:ControlParameter
          ControlID="lblUniqueId"
    ...
    <asp:SqlDataSource
      ...
      runat="server"
      ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
      UpdateCommand="UPDATE OrderDetails SET TubeSize=@TubeSize WHERE UniqueId=@UniqueId AND Active=1"
    >
      <UpdateParameters>
        <asp:ControlParameter
          ControlID="lblUniqueId"
    ...
    >
      <InsertParameters>
        ...
        />
        <asp:ControlParameter
          ControlID="lblSoeKitId"
          Name="SoeKitId"
          PropertyName="Text"
        />
        <asp:ControlParameter
          ControlID="lblExactId"
          Name="ExactId"
          PropertyName="Text"
        />
        <asp:ControlParameter
        ...
        />
        <asp:ControlParameter
          ControlID="lblChainId"
          Name="ChainId"
          PropertyName="Text"
        />
        <asp:ControlParameter
          ControlID="ddlRailColour"
          Name="BottomRailId"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
        ...
        />
        <asp:ControlParameter
          ControlID="lblCassetteExtraId"
          Name="CassetteExtraId"
          PropertyName="Text"
        />
        <asp:ControlParameter
          ControlID="txtQty"
        ...
        />
        <asp:ControlParameter
          ControlID="ddlControlPosition"
          Name="ControlPosition"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="lblChainLength"
          Name="ChainLength"
          PropertyName="Text"
        />
        <asp:ControlParameter

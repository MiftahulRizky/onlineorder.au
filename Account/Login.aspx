...
<html lang="en" data-bs-theme="light">
  <head runat="server">
    ...
    <link
      href="../Content/dist/css/tabler.min.css?1692870487"
      rel="stylesheet"
    />
    <link
      href="../Content/dist/css/tabler-flags.min.css?1692870487"
      rel="stylesheet"
    />
    <link
      href="../Content/dist/css/tabler-payments.min.css?1692870487"
      rel="stylesheet"
    />
    <link
      href="../Content/dist/css/tabler-vendors.min.css?1692870487"
      rel="stylesheet"
    />
    ...
    <link
      rel="icon"
      type="image/x-icon"
      href="../Content/static/new-favicon.png"
    />
    <link
      rel="stylesheet"
    ...
    <form id="form1" runat="server">
      <asp:ScriptManager runat="server">
        <Scripts>
          ...
          <asp:ScriptReference
            Path="~/Content/dist/js/demo-theme.min.js?1692870487"
          />
          <asp:ScriptReference
            Path="~/Content/dist/js/tabler.min.js?1692870487"
          />
          <asp:ScriptReference
            Path="~/Content/dist/js/demo.min.js?1692870487"
          />
          <asp:ScriptReference
            Path="~/Content/dist/js/demo-theme.min.js?1692870487"
          />
          <asp:ScriptReference
            Path="~/Scripts/jquery-3.7.0.min.js?1692870487"
          />
          <asp:ScriptReference
      ...
      <div class="page page-center">
        ...
        <div class="container container-tight py-4">
          <div class="mb-4 d-flex justify-content-center align-items-center">
            <!-- <h1>ORDER BLINDS</h1> -->
            <img src="/Content/static/new-icon.png" alt="" width="45%" />
          </div>
          ...
          <!-- <div class="text-center text-secondary mt-3">
            Want to order a panorama shutter?,
            <a href="https://shutters.onlineorder.au/" tabindex="-1"
              >click here.</a
            >
          </div> -->
        </div>

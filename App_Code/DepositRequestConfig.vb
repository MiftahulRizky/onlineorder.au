...
Public Class DepositRequestConfig
    ...
    Public Sub BindContentDeposit(Id As String, Files As String)
        ...
        Using fs As New FileStream(pdfFilePath, FileMode.Create)
            ...
            writer.PageEvent = New DepositEvents()
            doc.Open()
            ...
            ' Baris 1, Kolom 2
            Dim textRightCell1 As New PdfPCell(New Phrase("Deposit Request", headerFont))
            ...
            If detailData.Tables(0).Rows.Count > 0 Then
                For i As Integer = 0 To detailData.Tables(0).Rows.Count - 1
                    ...
                    Dim sizeB As String = widthB & " x " & drop
                    Dim sizeC As String = widthC & " x " & drop
                    Dim sizeD As String = widthD & " x " & drop
                    Dim sizeE As String = widthE & " x " & drop
                    Dim sizeF As String = widthF & " x " & drop

                    Dim productName As String = detailData.Tables(0).Rows(i)("ProductName").ToString()
                    Dim itemDescription As String = productName & " " & size
                    ...
                    If designName = "Cellular Shades" Or designName = "Curtain" Or designName = "Roman Blind" Or designName = "Skin Only" Or designName = "Veri Shades" Or designName = "Zebra Blind" Then
                        ...
                        itemDescription += fabricColourName & " - " & size
                    End If

                    If designName = "Pelmet" Then
                        itemDescription = productName
                        itemDescription += vbLf
                        itemDescription += fabricColourName & " - " & width
                    ...
                    If designName = "Vertical" Then
                        ...
                        If blindName = "Blades Only" Then
                            itemDescription = productName
                            itemDescription += vbLf
                            itemDescription += fabricColourName & " - " & drop
                        End If
                        If blindName = "Track Only" Then
                    ...
                    If designName = "Roller Blind" Then
                        ...
                        If blindName = "Double Bracket" Then
                            ...
                            itemDescription += fabricColourName & " - " & size
                            itemDescription += vbLf
                            itemDescription += fabricColourNameDB & " - " & size
                        End If
                        If blindName = "Link 2 Blinds Dep" Or blindName = "Link 2 Blinds Ind" Or blindName = "Link 2 Blinds Head to Tail" Then
                            ...
                            itemDescription += vbLf
                            itemDescription += "1: " & size & ", 2: " & sizeB
                        End If
                        If blindName = "Link 3 Blinds Dep" Or blindName = "Link 3 Blinds Ind with Dep" Or blindName = "Link 3 Blinds Head to Tail with Ind" Then
                            ...
                            itemDescription += fabricColourName
                            itemDescription += vbLf
                            itemDescription += "1: " & size & ", 2: " & sizeB & ", 3: " & sizeC
                        End If
                        If blindName = "Link 4 Blinds Ind with Dep" Then
                            ...
                            itemDescription += fabricColourName
                            itemDescription += vbLf
                            itemDescription += "1: " & size & ", 2: " & sizeB & ", 3: " & sizeC & ", 4: " & sizeD
                        End If
                        ...
                        If blindName = "DB Link 2 Blinds Dep" Or blindName = "DB Link 2 Blinds Ind" Then
                            ...
                            itemDescription += vbLf
                            itemDescription += "3: " & sizeC & ", 4: " & sizeD
                        End If
                        ...
                        If blindName = "DB Link 3 Blinds Dep" Or blindName = "DB Link 3 Blinds Ind with Dep" Then
                            ...
                            itemDescription += "Back: " & fabricColourNameDB
                            itemDescription += vbLf
                            itemDescription += "4: " & sizeD & ", 5: " & sizeE & ", 6: " & sizeF
                        End If
                    End If
                    ...
                    If designName = "Panorama PVC Shutters" Then
                        ...
                        itemDescription += vbLf
                        itemDescription += blindName & " - " & size
                    End If
            ...
            Dim footerCellDeposit As New PdfPCell(New Phrase("40% Deposit : ", smallFont))
            footerCellDeposit.HorizontalAlignment = Element.ALIGN_RIGHT
            footerCellDeposit.VerticalAlignment = Element.ALIGN_MIDDLE
            footerCellDeposit.Border = 0
            footerCellDeposit.Colspan = 4
            table.AddCell(footerCellDeposit)
            table.AddCell(CreateCellFooter("$ " & minDeposit.ToString("N2", enUS)))
...
Public Class DepositEvents
    ...
    Public Overrides Sub OnEndPage(writer As PdfWriter, document As Document)
        ...
        Dim imageUrl As String = Server.MapPath("~/Content/static/new-icon.png") '"https://shutters.onlineorder.au/Content/static/new-icon.png"
        ...
        Dim termsText As String = "• This deposit request has been calculated using the order that has been supplied and any changes may incur additional charges." & vbCrLf
        termsText += "• The order will not be processed until the deposit has been received." & vbCrLf
        termsText += "• The balance is to be paid prior to the order being released for installation." & vbCrLf
        termsText += "• If the deposit is not received wihtin 2 weeks of this notice, we will have no option but to assume your order is not required."

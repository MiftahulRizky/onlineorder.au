...
Public Class QuoteConfig
    ...
    Public Sub BindContentQuote(Id As String, Files As String)
        ...
        Using fs As New FileStream(pdfFilePath, FileMode.Create)
            ...
            Dim totalAllPrice As Decimal = GetItemData_Decimal("SELECT SUM(Cost + (Cost * MarkUp / 100)) FROM OrderDetails_Shutters WHERE HeaderId='" + Id + "' AND Active=1")
    ...
    Public Sub BindContentQuoteCustomer(Id As String, Files As String)
        ...
        Using fs As New FileStream(pdfFilePath, FileMode.Create)
            ...
            Dim totalAllPrice As Decimal = GetItemData_Decimal("SELECT SUM(FinalCost + (FinalCost * MarkUp / 100)) FROM OrderDetails_Shutters WHERE HeaderId='" + Id + "' AND Active=1")
...
Public Class QuoteEvents
    ...
    Public Overrides Sub OnEndPage(writer As PdfWriter, document As Document)
        ...
        Dim imageUrl As String = "https://shutters.onlineorder.au/Content/static/new-icon.png" 'baseUrl & "/Content/static/new-icon.png"

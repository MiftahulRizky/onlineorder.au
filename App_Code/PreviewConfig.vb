...
Public Class PreviewConfig
    ...
    Public Sub BindContent(Id As String, FilePath As String)
        ...
        Using fs As New FileStream(pdfFilePath, FileMode.Create, FileAccess.Write, FileShare.ReadWrite)
            ...
            Dim totalItems As Integer = GetItemData("SELECT SUM(TotalBlinds) FROM OrderDetails_Shutters WHERE HeaderId = '" + Id + "' AND Active = 1")
            ...
            Try
                Dim aluminiumData As DataSet = GetListData("SELECT OrderDetails_Shutters.*, Products.ColourType AS ColourType, Blinds.Name AS BlindName FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Aluminium Blind' AND OrderDetails_Shutters.Active=1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            Try
                Dim privacyData As DataSet = GetListData("SELECT OrderDetails_Shutters.*, Products.ColourType AS ColourType, Blinds.Name AS BlindName FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'LS Venetian' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            Try
                Dim venetianData As DataSet = GetListData("SELECT OrderDetails_Shutters.*, Products.ColourType AS ColourType, Blinds.Name AS BlindName FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Venetian Blind' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            Try
                Dim cellularData As DataSet = GetListData("SELECT OrderDetails_Shutters.*, Products.ControlType AS ControlType FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Cellular Shades' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            ' START CURTAIN
            Try
                Dim curtainData As DataSet = GetListData("SELECT OrderDetails_Shutters.*, Products.ControlType AS ControlType, Products.ColourType AS ColourType, Blinds.Name AS BlindName FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Curtain' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            ' START PANEL GLIDE
            Try
                Dim pgData As DataSet = GetListData("SELECT OrderDetails_Shutters.*, Products.TubeType AS TubeType, Products.ColourType AS ColourType, Blinds.Name AS BlindName FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Panel Glide' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            ' START PELMET
            Try
                Dim pelmetData As DataSet = GetListData("SELECT OrderDetails_Shutters.*, Products.ColourType AS ColourType, Blinds.Name AS BlindName FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Pelmet' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            ' START ROLLER BLIND
            Try
                Dim rollerData As DataSet = GetListData("SELECT OrderDetails_Shutters.Id, OrderDetails_Shutters.Number, OrderDetails_Shutters.Room, OrderDetails_Shutters.Mounting, OrderDetails_Shutters.Width AS Width, OrderDetails_Shutters.[Drop] AS Height, Blinds.Name AS BlindName, Products.TubeType AS TubeType, Products.ControlType, Products.ColourType, OrderDetails_Shutters.FabricId AS Fabric, OrderDetails_Shutters.FabricColourId AS FabricColour, OrderDetails_Shutters.Roll, OrderDetails_Shutters.ControlPosition, OrderDetails_Shutters.ChainId AS Chain, OrderDetails_Shutters.ControlLength AS ControlLength, OrderDetails_Shutters.RemoteChannel, OrderDetails_Shutters.BatteryCharger, OrderDetails_Shutters.ExtensionCable, OrderDetails_Shutters.BottomRailId AS BottomRail, OrderDetails_Shutters.WandExtendable AS BottomExtendable, OrderDetails_Shutters.SpringAssist, OrderDetails_Shutters.BracketSize, OrderDetails_Shutters.Adjusting, OrderDetails_Shutters.Notes, 1 AS Item FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Roller Blind' AND OrderDetails_Shutters.Active = 1 UNION ALL SELECT OrderDetails_Shutters.Id, OrderDetails_Shutters.Number, OrderDetails_Shutters.Room, OrderDetails_Shutters.Mounting, OrderDetails_Shutters.WidthB AS Width, OrderDetails_Shutters.DropB AS Height, Blinds.Name AS BlindName, Products.TubeType AS TubeType, Products.ControlType, Products.ColourType, OrderDetails_Shutters.FabricIdB AS Fabric, OrderDetails_Shutters.FabricColourIdB AS FabricColour, OrderDetails_Shutters.RollB, OrderDetails_Shutters.ControlPositionB, OrderDetails_Shutters.ChainIdB AS Chain, OrderDetails_Shutters.ControlLengthB AS ControlLength, OrderDetails_Shutters.RemoteChannel, OrderDetails_Shutters.BatteryCharger, OrderDetails_Shutters.ExtensionCable, OrderDetails_Shutters.BottomRailIdB AS BottomRail, OrderDetails_Shutters.WandExtendableB AS BottomExtendable, OrderDetails_Shutters.SpringAssist, OrderDetails_Shutters.BracketSize, OrderDetails_Shutters.Adjusting, OrderDetails_Shutters.Notes, 2 AS Item FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Roller Blind' AND (Blinds.Name IN ('Double Bracket', 'Link 2 Blinds Dep', 'Link 2 Blinds Head to Tail', 'Link 2 Blinds Ind', 'Link 3 Blinds Dep', 'Link 3 Blinds Head to Tail with Ind', 'Link 3 Blinds Ind with Dep', 'Link 4 Blinds Ind with Dep', 'DB Link 2 Blinds Dep', 'DB Link 2 Blinds Ind', 'DB Link 3 Blinds Dep', 'DB Link 3 Blinds Ind with Dep')) AND OrderDetails_Shutters.Active = 1 UNION ALL SELECT OrderDetails_Shutters.Id, OrderDetails_Shutters.Number, OrderDetails_Shutters.Room, OrderDetails_Shutters.Mounting, OrderDetails_Shutters.WidthC AS Width, OrderDetails_Shutters.DropC AS Height, Blinds.Name AS BlindName, Products.TubeType AS TubeType, Products.ControlType, Products.ColourType, OrderDetails_Shutters.FabricIdC AS Fabric, OrderDetails_Shutters.FabricColourIdC AS FabricColour, OrderDetails_Shutters.RollC, OrderDetails_Shutters.ControlPositionC, OrderDetails_Shutters.ChainIdC AS Chain, OrderDetails_Shutters.ControlLengthC AS ControlLength, OrderDetails_Shutters.RemoteChannel, OrderDetails_Shutters.BatteryCharger, OrderDetails_Shutters.ExtensionCable, OrderDetails_Shutters.BottomRailIdC AS BottomRail, OrderDetails_Shutters.WandExtendableC AS BottomExtendable, OrderDetails_Shutters.SpringAssist, OrderDetails_Shutters.BracketSize, OrderDetails_Shutters.Adjusting, OrderDetails_Shutters.Notes, 3 AS Item FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Roller Blind' AND (Blinds.Name IN ('Link 3 Blinds Dep', 'Link 3 Blinds Head to Tail with Ind', 'Link 3 Blinds Ind with Dep', 'Link 4 Blinds Ind with Dep', 'DB Link 2 Blinds Dep', 'DB Link 2 Blinds Ind', 'DB Link 3 Blinds Dep', 'DB Link 3 Blinds Ind with Dep')) AND OrderDetails_Shutters.Active = 1 UNION ALL SELECT OrderDetails_Shutters.Id, OrderDetails_Shutters.Number, OrderDetails_Shutters.Room, OrderDetails_Shutters.Mounting, OrderDetails_Shutters.WidthC AS Width, OrderDetails_Shutters.DropC AS Height, Blinds.Name AS BlindName, Products.TubeType AS TubeType, Products.ControlType, Products.ColourType, OrderDetails_Shutters.FabricIdC AS Fabric, OrderDetails_Shutters.FabricColourIdC AS FabricColour, OrderDetails_Shutters.RollC, OrderDetails_Shutters.ControlPositionC, OrderDetails_Shutters.ChainIdC AS Chain, OrderDetails_Shutters.ControlLengthC AS ControlLength, OrderDetails_Shutters.RemoteChannel, OrderDetails_Shutters.BatteryCharger, OrderDetails_Shutters.ExtensionCable, OrderDetails_Shutters.BottomRailIdC AS BottomRail, OrderDetails_Shutters.WandExtendableC AS BottomExtendable, OrderDetails_Shutters.SpringAssist, OrderDetails_Shutters.BracketSize, OrderDetails_Shutters.Adjusting, OrderDetails_Shutters.Notes, 4 AS Item FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Roller Blind' AND (Blinds.Name IN ('Link 4 Blinds Ind with Dep', 'DB Link 2 Blinds Dep', 'DB Link 2 Blinds Ind', 'DB Link 3 Blinds Dep', 'DB Link 3 Blinds Ind with Dep')) AND OrderDetails_Shutters.Active = 1 UNION ALL SELECT OrderDetails_Shutters.Id, OrderDetails_Shutters.Number, OrderDetails_Shutters.Room, OrderDetails_Shutters.Mounting, OrderDetails_Shutters.WidthC AS Width, OrderDetails_Shutters.DropC AS Height, Blinds.Name AS BlindName, Products.TubeType AS TubeType, Products.ControlType, Products.ColourType, OrderDetails_Shutters.FabricIdC AS Fabric, OrderDetails_Shutters.FabricColourIdC AS FabricColour, OrderDetails_Shutters.RollC, OrderDetails_Shutters.ControlPositionC, OrderDetails_Shutters.ChainIdC AS Chain, OrderDetails_Shutters.ControlLengthC AS ControlLength, OrderDetails_Shutters.RemoteChannel, OrderDetails_Shutters.BatteryCharger, OrderDetails_Shutters.ExtensionCable, OrderDetails_Shutters.BottomRailIdC AS BottomRail, OrderDetails_Shutters.WandExtendableC AS BottomExtendable, OrderDetails_Shutters.SpringAssist, OrderDetails_Shutters.BracketSize, OrderDetails_Shutters.Adjusting, OrderDetails_Shutters.Notes, 5 AS Item FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Roller Blind' AND (Blinds.Name IN ('DB Link 3 Blinds Dep', 'DB Link 3 Blinds Ind with Dep')) AND OrderDetails_Shutters.Active = 1 UNION ALL SELECT OrderDetails_Shutters.Id, OrderDetails_Shutters.Number, OrderDetails_Shutters.Room, OrderDetails_Shutters.Mounting, OrderDetails_Shutters.WidthC AS Width, OrderDetails_Shutters.DropC AS Height, Blinds.Name AS BlindName, Products.TubeType AS TubeType, Products.ControlType, Products.ColourType, OrderDetails_Shutters.FabricIdC AS Fabric, OrderDetails_Shutters.FabricColourIdC AS FabricColour, OrderDetails_Shutters.RollC, OrderDetails_Shutters.ControlPositionC, OrderDetails_Shutters.ChainIdC AS Chain, OrderDetails_Shutters.ControlLengthC AS ControlLength, OrderDetails_Shutters.RemoteChannel, OrderDetails_Shutters.BatteryCharger, OrderDetails_Shutters.ExtensionCable, OrderDetails_Shutters.BottomRailIdC AS BottomRail, OrderDetails_Shutters.WandExtendableC AS BottomExtendable, OrderDetails_Shutters.SpringAssist, OrderDetails_Shutters.BracketSize, OrderDetails_Shutters.Adjusting, OrderDetails_Shutters.Notes, 6 AS Item FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Roller Blind' AND (Blinds.Name IN ('DB Link 3 Blinds Dep', 'DB Link 3 Blinds Ind with Dep')) AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Id, OrderDetails_Shutters.Number, Item ASC")
            ...
            ' START ROMAN BLIND
            Try
                Dim romanData As DataSet = GetListData("SELECT OrderDetails_Shutters.*, Products.ControlType AS ControlType, Blinds.Name AS BlindName FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Roman Blind' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            ' START SKIN ONLY
            Try
                Dim skinData As DataSet = GetListData("SELECT OrderDetails_Shutters.* FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Skin Only' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            ' START VERI SHADES
            Try
                Dim verishadesData As DataSet = GetListData("SELECT OrderDetails_Shutters.* FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Veri Shades' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            ' START VERTICAL
            Try
                Dim verticalData As DataSet = GetListData("SELECT OrderDetails_Shutters.*, Products.ControlType AS ControlType, Products.TubeType AS TubeType, Products.ColourType AS ColourType, Blinds.Name AS BlindName FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id LEFT JOIN Blinds ON Products.BlindId = Blinds.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Vertical' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")
            ...
            ' START ZEBRA BLIND
            Try
                Dim zebraData As DataSet = GetListData("SELECT OrderDetails_Shutters.*, Products.ControlType AS ControlType FROM OrderDetails_Shutters LEFT JOIN Products ON OrderDetails_Shutters.ProductId = Products.Id LEFT JOIN Designs ON Products.DesignId = Designs.Id WHERE OrderDetails_Shutters.HeaderId = '" + Id + "' AND Designs.Name = 'Zebra Blind' AND OrderDetails_Shutters.Active = 1 ORDER BY OrderDetails_Shutters.Number ASC")

    ...
    $.ajax({
      ...
      success: function (response) {
        if (Array.isArray(response.d)) {
          ...
          Promise.all([bindProduct(selectedValue)])
            .then(resolve)
            .catch(reject);
        } else {
          resolve();
  ...
  getBlindName(blindType)
    .then((blindName) => {
      if (blindName === "Freight") {
        ...
        blindName === "Freight" ||
        blindName === "Check Measure" ||
        blindName === "Installation" ||
        blindName === "Takedown" ||
        blindName === "Travel Charge"
      ) {
        divType.style.display = "";
      ...
      getProductName(product)
        .then((productName) => {
          if (
            productName === "Template Fee" ||
            productName === "Blind Products" ||
            productName === "Concrete/Brick" ||
            productName === "Program Hub" ||
          ...
          if (
            productName === "Misc. Travel Charge" ||
            productName === "Other" ||
            productName === "TAS - NT - WA" ||
            productName === "Curtain" ||
            productName === "Parts"
          ) {

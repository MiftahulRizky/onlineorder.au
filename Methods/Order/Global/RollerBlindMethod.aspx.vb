...
Partial Class Methods_Order_RollerBlindMethod
    ...
    Public Shared Function Submit(ByVal data As ParamSubmit) As Object
        Try
            ...
            If width > 1810 AND data.tubetype = "38"  Then
                Return New With {.warning = true, .message = "cannot down grade to 38mm tube !",.field = "tubetype"}
            End If
            ...
            If Not data.tubetype = "N/A" Then
                ...
                If Not String.IsNullOrEmpty(data.trim) AND (data.trim = "Bottom Rail" OR data.trim = "Decorative") Then
                    If String.IsNullOrEmpty(data.railtype) Then
                        Return New With {.warning = true, .message = String.Format("{0} type is required !", data.trim),.field = "railtype"}
                    End If
            ...
            If BlindName = "Gear Reduction" Then
                ...
                '     Return New With {.warning = true, .message = "cannot down grade to 38mm tube !",.field = "tubesize"}
                ' End If
            End If
    ...
    Public Shared Function BindItemOrder(ByVal data As ParamBindItemOrder) As Object
        Try
            ...
            Dim DetailData As Object = BindOrderDetails(data.itemid)
            If DetailData.error Then
                Throw New Exception(DetailData.message)
            End If
            ...
            Dim Brackets As Object  = BindListData(New ParamListData With {
                .field = "brackettype",
                .designid = data.designid,
                .blindtype = DetailData.List("BlindId").ToString()
            })
            ...
            Dim Tubes As Object  = BindListData(New ParamListData With {
                ...
                .designid = data.designid,
                .blindtype = DetailData.List("BlindId").ToString(),
                .brackettype = DetailData.List("BracketType").ToString()
            })
            If Tubes.error Then
            ...
            Dim Controls As Object  = BindListData(New ParamListData With {
                ...
                .blindtype = DetailData.List("BlindId").ToString(),
                .brackettype = DetailData.List("BracketType").ToString(),
                .tubetype = DetailData.List("TubeType").ToString()
            })
            ...
            Dim Colours As Object  = BindListData(New ParamListData With {
                ...
                .brackettype = DetailData.List("BracketType").ToString(),
                .tubetype = DetailData.List("TubeType").ToString(),
                .controltype = DetailData.List("ControlType").ToString()
            })
            ...
            Dim FabricColours As Object  = BindListData(New ParamListData With {
                .field = "fabriccolour",
                .designid = data.designid,
                .fabrictype = DetailData.List("FabricType").ToString()
            })
            ...
            Dim Rails As Object  = BindListData(New ParamListData With {
                .field = "railtype",
                .brackettype = SafeString(DetailData.List("BracketType")),
                .trim = SafeString(DetailData.List("Trim"))
            })
            If Rails.error Then
            ...
            Dim RailColours As Object  = BindListData(New ParamListData With {
                ...
                .brackettype = SafeString(DetailData.List("BracketType")),
                .trim = SafeString(DetailData.List("Trim")),
                .railtype = SafeString(DetailData.List("BottomType"))
            })
            If RailColours.error Then
                Throw New Exception(RailColours.message)
            End If
            
            Dim NextDesc As Object = FindNextDescription(DetailData.List, data.itemaction)
            If NextDesc.error Then
                Throw New Exception(NextDesc.message)
            End If
            DetailData.List("NextDescText") = NextDesc.text
            DetailData.List("NextDescVisible") = NextDesc.visible


            Return New With {
                .DetailData = DetailData.list,
    ...
    Private Shared Function BindOrderDetails(itemid As String) As Object
        Try 
            Dim DetailData As New Dictionary(Of String, Object)()
            Using conn As New SqlConnection(myConn)
                Using cmd As New SqlCommand("SELECT * FROM view_details WHERE Id = @Id", conn)
            ...
            Return New With {.error = False, .list = DetailData}
        Catch ex As Exception
            Return New With {.error = True, .message = String.Format("BindOrderDetails: {0}", ex.Message)}
        End Try
    End Function

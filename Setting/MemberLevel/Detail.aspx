<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Detail.aspx.vb" Inherits="Setting_MemberLevel_Detail" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.master" Debug="true" Title="Detail Member Level" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Detail Member Level</h3>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-8 col-sm-12">
                                    <asp:TextBox runat="server" TextMode="MultiLine" Height="100px" ID="txtDescription" CssClass="form-control" placeholder="Description ..." autocomplete="off" style="resize:none;"></asp:TextBox>
                                </div>
                            </div>
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE LevelMembers SET Name=@Name, Description=@Description, Active=@Active WHERE Id=@Id">
            <UpdateParameters>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_MemberLevel_Default" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.master" Debug="true" Title="Member Level" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">Member Level</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Member Level</h3>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="True" EmptyDataText="LEVEL DATA NOT FOUND :)" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Position="TopAndBottom" PageSize="50" OnPageIndexChanging="gvList_PageIndexChanging">
                                <RowStyle />
                                <Columns>
    ...
    <script type="text/javascript">
        ...
        function showDelete(id, name) {
            var result = 'Are you sure you want to delete this member level?';
            result += '<br /><br />';
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsLevel" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE MembersLevel SET Active=@Active WHERE Id=@Id" DeleteCommand="DELETE FROM MembersLevel WHERE Id=@Id">
            <UpdateParameters>

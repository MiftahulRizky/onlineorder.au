Partial Class Setting_Role_Default
    Inherits Page
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("~/setting/role/add", False)
    End Sub
    ...
    Protected Sub linkDetail_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Session("roleSearch") = txtSearch.Text
            Session("roleDetail") = UCase(row.Cells(1).Text)

            Response.Redirect("~/setting/role/detail", False)
        Catch ex As Exception
            Call MessageError(True, ex.ToString())
        End Try
    End Sub
    ...
    Protected Sub btnDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            publicCfg.InsertActivity(userId, Page.Title, "DELETE ROLE MEMBER. ID : " & lblId.Text)
    ...
    Protected Sub linkActive_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim userId As String = UCase(Session("UserId")).ToString()
            publicCfg.InsertActivity(userId, Page.Title, "ACTIVE ROLE MEMBER. ID : " & lblId.Text)
    ...
    Private Sub BindData(SearchText As String)
        Session("roleDetail") = "" : Session("roleSearch") = ""
        Try
            ...
            gvList.DataSource = publicCfg.GetListData(String.Format("SELECT *, LEFT(Description, 20) AS RoleDesc FROM Roles {0} ORDER BY Name ASC", search))
            gvList.DataBind()
        Catch ex As Exception
            Call MessageError(True, ex.ToString())
        End Try

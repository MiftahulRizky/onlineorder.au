...
Partial Class Setting_Role_Detail
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Session("roleDetail") = "" Then
            Response.Redirect("~/setting/role", False)
            Exit Sub
        End If

        lblId.Text = Session("roleDetail")
        If Not IsPostBack Then
            Call BackColor()
            Call BindDataRole(lblId.Text)
        End If
    End Sub
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If msgError.InnerText = "" Then
                ...
                publicCfg.InsertActivity(userId, Page.Title, "UPDATE ROLE MEMBER. ID : " & lblId.Text)
    ...
    Private Sub BindDataRole(Id As String)
        Try
            Dim myData As DataSet = publicCfg.GetListData("SELECT * FROM Roles WHERE Id = '" + Id + "'")

...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="modal-body">
                    <div class="mb-5 row">
                        ...
                        <div class="col-9">
                            ...
                            <asp:TextBox runat="server" ID="txtName" CssClass="form-control" placeholder="Customer Group Name ..." autocomplete="off"></asp:TextBox>
                        </div>
                    </div>
    ...
    <div class="modal modal-blur fade" id="modalCustomer" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row" runat="server" id="divErrorCustomer">
                        <div class="col-12">
                            <div class="alert alert-important alert-danger alert-dismissible" role="alert">
                                <div class="d-flex">
                                    <div>
                                    ...
                                    <div>
                                        <span runat="server" id="msgErrorCustomer"></span>
                                    </div>
                                </div>
                                <a class="btn-close" data-bs-dismiss="alert" aria-label="close"></a>
                            </div>

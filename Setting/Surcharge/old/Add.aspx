<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Add.aspx.vb" Inherits="Setting_Surcharge_Add" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Add Surcharge" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO Surcharges VALUES (NEWID(), @DesignId, @BlindId, @BlindNo, @Name, @FieldName, @Formula, @Charge, @Description, @Active)">
            <InsertParameters>

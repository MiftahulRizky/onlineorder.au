<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Detail.aspx.vb" Inherits="Setting_Surcharge_Detail" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Detail Surcharge" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-6 row">
                                ...
                                <div class="col-lg-9 col-md-12 col-sm-12">
                                    <asp:TextBox runat="server" ID="txtCharge" TextMode="MultiLine" Height="100px" CssClass="form-control" placeholder="Charge ..." autocomplete="off" style="resize:none;"></asp:TextBox>
                                </div>
                            </div>
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE Surcharges SET DesignId=@DesignId, BlindId=@BlindId, BlindNo=@BlindNo, Name=@Name, FieldName=@FieldName, Formula=@Formula, Charge=@Charge, Description=@Description, Active=@Active WHERE Id=@Id">
            <UpdateParameters>

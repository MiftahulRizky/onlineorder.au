<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_Surcharge_Default" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Surcharge" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-actions">
                                <asp:LinkButton runat="server" ID="btnAdd" CssClass="btn btn-primary " Text="Add Surcharge" OnClick="btnAdd_Click" >
                                    <i class="fa-regular fa-plus" style="margin-right: 0.3rem;"></i> Add Surcharge
                                </asp:LinkButton>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="True" PagerSettings-Position="TopAndBottom" EmptyDataText="SURCHARGE DATA NOT FOUND :)" EmptyDataRowStyle-HorizontalAlign="Center" PageSize="50" OnPageIndexChanging="gvList_PageIndexChanging">
                                <RowStyle />
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="240px">
                                        <ItemTemplate>
                                            <div class="float-end">
                                                ...
                                                <asp:LinkButton runat="server" title="Copy" ID="linkCopy" CssClass="btn btn-info" Text="Copy" OnClick="linkCopy_Click" style="height: 2.3em; width: 2em;">
    ...
    <div runat="server" visible="false">
        ...
        <asp:Label runat="server" ID="lblActive"></asp:Label>
         ...
         <asp:SqlDataSource runat="server" ID="sdsReset" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM Surcharges"></asp:SqlDataSource>

        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO Surcharges SELECT NEWID(), DesignId, BlindId, '', Name + ' - Copy', FieldName, Formula, Charge, Description, Active FROM Surcharges WHERE Id=@Id" UpdateCommand="UPDATE Surcharges SET Active=@Active WHERE Id=@Id" DeleteCommand="DELETE FROM Surcharges WHERE Id=@Id">
            <InsertParameters>

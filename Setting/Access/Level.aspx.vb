...
Partial Class Setting_Access_Level
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Session("RoleName") = "Administrator" Then
            Response.Redirect("~/setting/access", False)
            Exit Sub
        End If
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        ...
        Try
            lblAction.Text = "Add"
            titleProcess.InnerText = "Add Login Level"
    ...
    Protected Sub btnCancel_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("~/setting/access/level", False)
    End Sub
        ...
        If Not String.IsNullOrEmpty(e.CommandArgument) Then
            ...
            If e.CommandName = "Detail" Then
                ...
                Try
                    lblId.Text = dataId
                    lblAction.Text = "Edit"
                    titleProcess.InnerText = "Edit Login Level"

                    Dim myData As DataSet = settingCfg.GetListData("SELECT * FROM CustomerLoginLevels WHERE Id = '" + lblId.Text + "'")
            ...
            ElseIf e.CommandName = "Log" Then
                ...
                Try
                    gvListLogs.DataSource = settingCfg.GetListData("SELECT * FROM Log_Access WHERE DataId = '" + dataId + "' AND Type='LoginLevels' ORDER BY ActionDate DESC")
                    gvListLogs.DataBind()
    ...
    Protected Sub btnSubmitProcess_Click(sender As Object, e As EventArgs)
        ...
        Try
            If txtName.Text = "" Then
                MessageError_Process(True, "LOGIN LEVEL NAME IS REQUIRED !")
                ClientScript.RegisterStartupScript(Me.GetType(), "showProcess", thisScript, True)
                Exit Sub
            End If
            ...
            If msgErrorProcess.InnerText = "" Then
                ...
                If lblAction.Text = "Add" Then
                    ...
                    Using thisConn As New SqlConnection(myConn)
                        Using myCmd As SqlCommand = New SqlCommand("INSERT INTO CustomerLoginLevels OUTPUT INSERTED.Id VALUES (NEWID(), @Name, @Description, @Active)")
                ...
                If lblAction.Text = "Edit" Then
                    Using thisConn As New SqlConnection(myConn)
                        Using myCmd As SqlCommand = New SqlCommand("UPDATE CustomerLoginLevels SET Name=@Name, Description=@Description, Active=@Active WHERE Id=@Id")
    ...
    Protected Sub btnSubmitDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using myCmd As SqlCommand = New SqlCommand("DELETE FROM CustomerLoginLevels WHERE Id=@Id UPDATE CustomerLogins SET LevelId=NULL WHERE RoleId=@Id")
                    myCmd.Parameters.AddWithValue("@Id", lblId.Text)
    ...
    Private Sub BindData(SearchText As String)
        Try
            ...
            End If
            gvList.DataSource = settingCfg.GetListData(String.Format("SELECT *, CASE WHEN Active=1 THEN 'Yes' WHEN Active=0 THEN 'No' ELSE 'Error' END AS DataActive FROM CustomerLoginLevels {0} ORDER BY Name ASC", search))
            gvList.DataBind()
    ...
    Protected Function BindTextLog(Id As String) As String
        ...
        Try
            Dim thisData As DataSet = settingCfg.GetListData("SELECT * FROM Log_Access WHERE Id = '" + Id + "'")
    ...
    Protected Function VisibleAction() As Boolean
        If Session("LevelName") = "Leader" OR Session("LevelName") = "Super Admin" Then Return True
        Return False
    End Function
End Class

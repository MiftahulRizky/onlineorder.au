...
Partial Class Setting_Access_Role
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            txtSearch.Text = Session("roleSearch")
    ...
    Protected Sub btnCancel_Click(sender As Object, e As EventArgs)
        Session("roleSearch") = txtSearch.Text
        Response.Redirect("~/setting/access/role", False)
    End Sub
        ...
        If Not String.IsNullOrEmpty(e.CommandArgument) Then
            ...
            If e.CommandName = "Detail" Then
                ...
                Try
                    ...
                    Dim myData As DataSet = settingCfg.GetListData("SELECT * FROM CustomerLoginRoles WHERE Id = '" + lblId.Text + "'")
            ...
            ElseIf e.CommandName = "Log" Then
                ...
                Try
                    gvListLogs.DataSource = settingCfg.GetListData("SELECT * FROM Log_Access WHERE DataId = '" + dataId + "' AND Type='LoginRoles' ORDER BY ActionDate DESC")
                    gvListLogs.DataBind()
    ...
    Protected Sub btnSubmitDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using thisConn As New SqlConnection(myConn)
                Using myCmd As SqlCommand = New SqlCommand("DELETE FROM CustomerLoginRoles WHERE Id=@Id UPDATE CustomerLogins SET RoleId=NULL WHERE RoleId=@Id")
    ...
    Protected Sub btnSubmitProcess_Click(sender As Object, e As EventArgs)
        ...
        Try
            If txtName.Text = "" Then
                MessageError_Process(True, "LOGIN ROLE NAME IS REQUIRED !")
                ClientScript.RegisterStartupScript(Me.GetType(), "showProcess", thisScript, True)
                Exit Sub
            End If
            ...
            If msgErrorProcess.InnerText = "" Then
                ...
                If lblAction.Text = "Add" Then
                    ...
                    Using thisConn As New SqlConnection(myConn)
                        Using myCmd As SqlCommand = New SqlCommand("INSERT INTO CustomerLoginRoles OUTPUT INSERTED.Id VALUES (NEWID(), @Name, @Description, @Active)")
                ...
                If lblAction.Text = "Edit" Then
                    Using thisConn As New SqlConnection(myConn)
                        Using myCmd As SqlCommand = New SqlCommand("UPDATE CustomerLoginRoles SET Name=@Name, Description=@Description, Active=@Active WHERE Id=@Id")
                            myCmd.Parameters.AddWithValue("@Id", lblId.Text)
                            myCmd.Parameters.AddWithValue("@Name", txtName.Text.Trim())
                            myCmd.Parameters.AddWithValue("@Description", descText)
                            myCmd.Parameters.AddWithValue("@Active", ddlActive.SelectedValue)
    ...
    Private Sub BindData(SearchText As String)
        Try
            ...
            gvList.DataSource = settingCfg.GetListData(String.Format("SELECT *, CASE WHEN Active=1 THEN 'Yes' WHEN Active=0 THEN 'No' ELSE 'Error' END AS DataActive FROM CustomerLoginRoles {0} ORDER BY Name ASC", search))
            gvList.DataBind()

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Level.aspx.vb" Inherits="Setting_Access_Level" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Login Level" %>
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">Login Level</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Login Level</h3>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" AllowPaging="true" EmptyDataText="LEVEL DATA NOT FOUND :)" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Position="TopAndBottom" PageSize="50" OnPageIndexChanging="gvList_PageIndexChanging" OnRowCommand="gvList_RowCommand">
                                <RowStyle />
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Name" HeaderText="Level Name" />
                ...
                <div class="modal-body">
                    <div class="mb-5 row">
                        <div class="col-12">
                            ...
                            <asp:TextBox runat="server" ID="txtName" CssClass="form-control" placeholder="Level Name ..." autocomplete="off"></asp:TextBox>
                        </div>
                    </div>

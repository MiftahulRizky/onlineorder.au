<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Add.aspx.vb"
Inherits="Setting_Store_Add" MaintainScrollPositionOnPostback="true"
MasterPageFile="~/Site.master" Debug="true" Title="Add Store" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div runat="server" visible="false">
    <asp:SqlDataSource
      ...
      InsertCommand="INSERT INTO Stores VALUES (@Id, @Name, @Company, @RegionId, @Type, @Address, @Phone, @Email, @Delivery, @Fax, @Abn, @Terms, 'yourlogo.png', @Active)"
    >
      <InsertParameters>

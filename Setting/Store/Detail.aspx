<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Detail.aspx.vb"
Inherits="Setting_Store_Detail" MaintainScrollPositionOnPostback="true"
MasterPageFile="~/Site.master" Debug="true" Title="Detail Store" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-lg-7 col-md-12 col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="mb-6 row">
                <label class="col-lg-3 col-form-label">DELIVERY/PICK UP</label>
                <div class="col-lg-3 col-sm-12 col-md-12">
                  <asp:DropDownList
                    runat="server"
                    ID="ddlDelivery"
  ...
  <div runat="server" visible="false">
    <asp:SqlDataSource
      ...
      UpdateCommand="UPDATE Stores SET Name=@Name, Company=@Company, RegionId=@RegionId, Type=@Type, Address=@Address, Phone=@Phone, Email=@Email, Delivery=@Delivery, Fax=@Fax, ABN=@Abn, Terms=@Terms, Active=@Active WHERE Id=@Id"
    >
      <UpdateParameters>

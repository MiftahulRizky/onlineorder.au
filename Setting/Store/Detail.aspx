<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Detail.aspx.vb" Inherits="Setting_Store_Detail" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.master" Debug="true" Title="Detail Store" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" visible="false">
        <asp:SqlDataSource ID="sdsStore" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE Stores SET Name=@Name, Company=@Company, RegionId=@RegionId, Type=@Type, Address=@Address, Phone=@Phone, Email=@Email, Fax=@Fax, ABN=@Abn, Terms=@Terms, Active=@Active WHERE Id=@Id">
            <UpdateParameters>

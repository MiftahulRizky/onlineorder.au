...
Inherits="Setting_Store_Default" MaintainScrollPositionOnPostback="true"
MasterPageFile="~/Site.master" Debug="true" Title="Store" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
          ...
          <div class="card">
            ...
            <div class="table-responsive">
              <asp:GridView
                ...
                AllowPaging="True"
                EmptyDataText="STORE DATA NOT FOUND :)"
  ...
  <script type="text/javascript">
    ...
    function showDelete(id, name) {
      ...
      result += "<br /><br />";
      result +=
        "<b>DATA : " + name.toUpperCase() + " | " + id.toUpperCase() + "</b>";
  ...
  <div runat="server" visible="false">
    ...
    <asp:SqlDataSource
      ...
      UpdateCommand="UPDATE Stores SET Active=@Active WHERE Id=@Id"
      DeleteCommand="DELETE FROM Stores WHERE Id=@Id"
    >
      <UpdateParameters>

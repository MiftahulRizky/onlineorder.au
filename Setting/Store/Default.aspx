<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="Setting_Store_Default" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.master" Debug="true" Title="Store" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="True" EmptyDataText="STORE DATA NOT FOUND :)" PagerSettings-Position="TopAndBottom" EmptyDataRowStyle-HorizontalAlign="Center" PageSize="25" OnPageIndexChanging="gvList_PageIndexChanging">
                                <RowStyle />
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="220px">
                                        <ItemTemplate>
                                            <div class="float-end">
                                                <%-- <asp:LinkButton runat="server" title="Detail" ID="linkDetail" CssClass="btn btn-primary" OnClick="linkDetail_Click" style="height: 2.3em; width: 2em;">
    ...
    <script type="text/javascript">
        ...
        function showDelete(id, name) {
            var result = 'Are you sure you want to delete this store?';
            result += '<br /><br />';
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource ID="sdsPage" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE Stores SET Active=@Active WHERE Id=@Id" DeleteCommand="DELETE FROM Stores WHERE Id=@Id">
            <UpdateParameters>

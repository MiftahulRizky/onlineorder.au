<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Group.aspx.vb" Inherits="Setting_Price_Group" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Product Price Group" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Product Price Group</h3>
                        ...
                        <div class="card-body border-bottom py-3">
                            <div class="d-flex">
                                <div class="text-secondary">
                                    <asp:DropDownList runat="server" ID="ddlDesignSearch" CssClass="form-select" AutoPostBack="true" OnSelectedIndexChanged="ddlDesignSearch_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="true" ShowHeaderWhenEmpty="true" EmptyDataText="PRICE GROUP DATA NOT FOUND ... :)" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Position="TopAndBottom" PageSize="25" OnPageIndexChanging="gvList_PageIndexChanging" OnRowCommand="gvList_RowCommand">
                                <RowStyle />
                                <Columns>
                        ...
                        <div class="card-footer text-setart"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3>Delete Product Price Group</h3>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Detail.aspx.vb" Inherits="Setting_Application_Detail" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Detail Application" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <label class="col-md-3 col-form-label required">NAME</label>
                            ...
                            <div class="mb-3 row">
                                <label class="col-md-3 col-form-label">DESCRITPION</label>
                                <div class="col-lg-8 col-sm-12 col-md-12">
                                    <asp:TextBox runat="server" TextMode="MultiLine" ID="txtDescription" Height="150px" CssClass="form-control" placeholder="Description ......" autocomplete="off" style="resize:none;"></asp:TextBox>
                                </div>
                            </div>

                            <div class="mb-3 row">
                                <label class="col-md-3 col-form-label required">ACTIVE</label>
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE Applications SET Name=@Name, Description=@Description, Active=@Active WHERE Id=@Id">
            <UpdateParameters>

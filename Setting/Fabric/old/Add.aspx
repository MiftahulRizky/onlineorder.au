<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Add.aspx.vb" Inherits="Setting_Fabric_Add" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Add Fabric" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3 row">
                                <label class="col-lg-3 col-form-label">FABRIC ID</label>
                            ...
                            <div class="mb-6 row">
                                <label class="col-lg-3 col-form-label">FABRIC NAME</label>
                            ...
                            <div class="mb-3 row">
                                <label class="col-lg-3 col-form-label">FABRIC WIDTH</label>
                            ...
                            <div class="mb-6 row">
                                <label class="col-lg-3 col-form-label">FABRIC GROUP</label>
                                <div class="col-lg-5 col-sm-12">
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO Fabrics VALUES (@Id, @DesignId, @Name, @Type, @Colour, @Width, @Group, @Description, @Active)">
            <InsertParameters>

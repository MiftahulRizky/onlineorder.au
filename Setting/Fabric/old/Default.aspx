<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="Setting_Fabric_Default" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Fabric" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-actions">
                                <asp:LinkButton runat="server" ID="btnAdd" CssClass="btn btn-primary "  OnClick="btnAdd_Click" >
                                    <i class="fa-solid fa-plus" style="margin-right: 0.3rem;"></i>Add Fabric
                                </asp:LinkButton>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="True" PagerSettings-Position="TopAndBottom" EmptyDataText="FABRIC DATA NOT FOUND :)" EmptyDataRowStyle-HorizontalAlign="Center" PageSize="30" OnPageIndexChanging="gvList_PageIndexChanging">
                                <RowStyle />
                                <Columns>
    ...
    <script type="text/javascript">
        function showDelete(id, name) {
            var result = 'Are you sure you want to delete this fabric?';
            result += '<br /><br />';
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE Fabrics SET Active=@Active WHERE Id=@Id" DeleteCommand="DELETE FROM Fabrics WHERE Id=@Id">
            <UpdateParameters>

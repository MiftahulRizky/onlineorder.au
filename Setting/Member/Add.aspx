<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Add.aspx.vb" Inherits="Setting_Member_Add" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.master" Debug="true" Title="Add Membership" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12">
                                    <a class="btn btn-primary " data-bs-toggle="offcanvas" href="#canvasPassword" role="button" aria-controls="canvasPassword">
                            ...
                            <div class="mb-3 row" runat="server" id="divFindStore">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="canvasPassword" aria-labelledby="canvasPasswordLabel">
        <div class="offcanvas-header">
            <h2 class="offcanvas-title" id="canvasPasswordLabel"></h2>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <div class="text-body">
                <span id="spanInfo" style="font-size:large;">
                    If it is not filled, it will follow the system standard, which is <b>123456</b>
                </span>
            </div>
            <div class="mt-3">
                <button class="btn btn-primary " type="button" data-bs-dismiss="offcanvas">
                    <i class="bi bi-check-circle me-2"></i> Ok. I Got It
                </button>
            </div>
        </div>
    </div>
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource ID="sdsPageMember" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO Memberships VALUES (@AppId, NEWID(), @RoleId, @LevelId, @UserName, @Password, '', 0, 0, 0, 0, NULL)">
            <InsertParameters>
        ...
        <asp:SqlDataSource ID="sdsPageUsers" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO Users VALUES (@UserId, @StoreId, @FullName, @Phone, @Email, @MarkUp, @Price)">
            <InsertParameters>

Partial Class Setting_Company_Default
    Inherits Page
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            txtSearch.Text = Session("companySearch")
            Call BindData(txtSearch.Text)
        End If
    End Sub

    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Session("companySearch") = txtSearch.Text
        Response.Redirect("~/setting/company/add", False)
    End Sub
    ...
    Protected Sub linkDetail_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Session("companySearch") = txtSearch.Text
            Session("companyDetail") = row.Cells(1).Text
            Response.Redirect("~/setting/company/detail", False)
        Catch ex As Exception
            Call MessageError(True, ex.ToString())
        End Try
    End Sub
    ...
    Protected Sub btnDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            publicCfg.InsertActivity(userId, Page.Title, "DELETE COMPANY. ID : " & lblId.Text)
    ...
    Protected Sub linkActive_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim userId As String = UCase(Session("UserId")).ToString()
            publicCfg.InsertActivity(userId, Page.Title, "ACTIVE COMPANY. ID : " & lblId.Text)
    ...
    Private Sub BindData(SearchText As String)
        Session("companyDetail") = "" : Session("companySearch") = ""
        Try
            ...
            gvList.DataSource = publicCfg.GetListData(String.Format("SELECT * FROM Company {0} ORDER BY Id ASC", search))
            gvList.DataBind()
        Catch ex As Exception
            Call MessageError(True, ex.ToString())
        End Try

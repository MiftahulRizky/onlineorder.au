...
Inherits="Setting_Discount_Detail" MaintainScrollPositionOnPostback="true"
MasterPageFile="~/Site.master" Debug="true" Title="Detail Discount" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div runat="server" visible="false">
    ...
    <asp:SqlDataSource
      ...
      UpdateCommand="UPDATE Discounts SET Discount=@Discount, Description=@Description, Active=@Active WHERE Id=@Id"
    >
      <UpdateParameters>

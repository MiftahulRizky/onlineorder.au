<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_Discount_Default" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.master" Debug="true" Title="Discount" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Discount</h3>
                            <div class="card-actions">
                                <asp:LinkButton runat="server" ID="btnAdd" CssClass="btn btn-primary " Text="Add New" OnClick="btnAdd_Click" >
                                    <i class="fa-regular fa-plus" style="margin-right: 0.3rem;"></i> Add Discount
                                </asp:LinkButton>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="True" Position="TopAndBottom" EmptyDataText="DISCOUNT DATA NOT FOUND :)" EmptyDataRowStyle-HorizontalAlign="Center" PageSize="50" OnPageIndexChanging="gvList_PageIndexChanging">
                                <RowStyle />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Store Name">
                                        <ItemTemplate>
                                            <%# IconActiveOnNames(Eval("Active").ToString(), Eval("StoreName").ToString()) %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="PriceGroupName" HeaderText="Discount Name" />
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px">
                                        <ItemTemplate>
                                            <div class="float-end">
                                                <%-- <asp:LinkButton runat="server" ID="linkDetail" CssClass="btn btn-primary" OnClick="linkDetail_Click" >
                                                    <i class="fa-regular fa-eye"></i>
                                                </asp:LinkButton>
                                                
                                                <a href="#" title="Delete" runat="server" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalDelete" onclick='<%# String.Format("return showDelete(`{0}`, `{1}`);", Eval("Id").ToString(), Eval("PriceGroupName").ToString()) %>' style="height: 2.3em; width: 2em;">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)" runat="server" class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#modalDelete" onclick='<%# String.Format("return showDelete(`{0}`, `{1}`);", Eval("Id").ToString(), Eval("PriceGroupName").ToString()) %>'>
                                ...
                                <PagerStyle BackColor="" ForeColor="DodgerBlue" HorizontalAlign="Center" CssClass="text-danger" />
    ...
    <script type="text/javascript">
        ...
        function showDelete(id, name) {
            var result = 'Are you sure you want to delete this discount?';
            result += '<br /><br />';
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource ID="sdsApp" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM Discounts WHERE Id=@Id" UpdateCommand="UPDATE Discounts SET Active=@Active WHERE Id=@Id">
            <DeleteParameters>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Bracket.aspx.vb" Inherits="Setting_Kit_Bracket" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Bracket Type" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">Bracket Type</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-9 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Bracket Type</h3>
                            <div class="card-actions">
                                <a class="btn btn-primary " data-bs-toggle="offcanvas" href="#canvasAdd" role="button" aria-controls="canvasAdd">
                                    <i class="fa-solid fa-plus me-2"></i>Add New
                                </a>
                                <asp:LinkButton runat="server" ID="btnKit" CssClass="btn btn-success " OnClick="btnKit_Click" >
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter card-table" AutoGenerateColumns="false" AllowPaging="True" EmptyDataText="BRACKET TYPE DATA NOT FOUND" PageSize="15" PagerSettings-Position="TopAndBottom" OnPageIndexChanging="gvList_PageIndexChanging">
                                <RowStyle />
                                <Columns>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasAdd" aria-labelledby="canvasAddLabel">
        <div class="offcanvas-header">
            <h2 class="offcanvas-title" id="canvasAddLabel">Add Bracket Type</h2>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasEdit" aria-labelledby="canvasEditLabel">
        <div class="offcanvas-header">
            <h2 class="offcanvas-title" id="canvasEditLabel">Edit Bracket Type</h2>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <div class="mb-5 row">
    ...
    <script type="text/javascript">
        function showDelete(id, name) {
            var result = 'Are you sure you want to delete this bracket type?';
            result += '<br /><br />';
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource ID="sdsAddUpdate" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO BracketType VALUES (NEWID(), @Name, @Description, @Active)" UpdateCommand="UPDATE BracketType SET Name=@Name, Description=@Description WHERE Id=@Id">
            <InsertParameters>
        ...
        <asp:SqlDataSource ID="sdsPage" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM BracketType WHERE Id=@Id" UpdateCommand="UPDATE BracketType SET Active=@Active WHERE Id=@Id">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lblId" Name="Id" PropertyName="Text" />
            </DeleteParameters>
            <UpdateParameters>

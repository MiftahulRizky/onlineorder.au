<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Control.aspx.vb" Inherits="Setting_Kit_Control" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Control Type" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource ID="sdsAddUpdate" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO ControlType VALUES (NEWID(), @Name, @Description, @Active)" UpdateCommand="UPDATE ControlType SET Name=@Name, Description=@Description, Active=@Active WHERE Id=@Id">
            <InsertParameters>
        ...
        <asp:SqlDataSource ID="sdsPage" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM ControlType WHERE Id=@Id" UpdateCommand="UPDATE ControlType SET Active=@Active WHERE Id=@Id">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lblId" Name="Id" PropertyName="Text" />
            </DeleteParameters>
            <UpdateParameters>

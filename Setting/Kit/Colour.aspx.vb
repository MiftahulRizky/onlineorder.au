Partial Class Setting_Kit_Colour
    Inherits Page
    ...
    Protected Sub btnDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            publicCfg.InsertActivity(userId, Page.Title, "DELETE COLOUR TYPE. ID : " & lblId.Text)
    ...
    Protected Sub linkActive_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim userId As String = UCase(Session("UserId")).ToString()
            publicCfg.InsertActivity(userId, Page.Title, "ACTIVE COLOUR TYPE. ID : " & lblId.Text)
    ...
    Private Sub BindData(SearchText As String)
        Try
            ...
            End If
            gvList.DataSource = publicCfg.GetListData(String.Format("SELECT * FROM ColourType {0} ORDER BY Name ASC", search))
            gvList.DataBind()
        Catch ex As Exception
            Call MessageError(True, ex.ToString())
        End Try

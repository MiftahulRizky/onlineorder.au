<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tube.aspx.vb" Inherits="Setting_Kit_Tube" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Tube Type" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">Tube Type</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-9 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Tube Type</h3>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter card-table" AutoGenerateColumns="false" AllowPaging="True" EmptyDataText="TUBE TYPE DATA NOT FOUND" PageSize="15" PagerSettings-Position="TopAndBottom" OnPageIndexChanging="gvList_PageIndexChanging">
                                <RowStyle />
                                <Columns>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasAdd" aria-labelledby="canvasAddLabel">
        <div class="offcanvas-header">
            <h2 class="offcanvas-title" id="canvasAddLabel">Add Tube Type</h2>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="canvasEdit" aria-labelledby="canvasEditLabel">
        <div class="offcanvas-header">
            <h2 class="offcanvas-title" id="canvasEditLabel">Edit Tube Type</h2>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <div class="mb-5 row">
    ...
    <script type="text/javascript">
        function showDelete(id, name) {
            var result = 'Are you sure you want to delete this tube type?';
            result += '<br /><br />';
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource ID="sdsAddUpdate" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO TubeType VALUES (NEWID(), @Name, @Description, @Active)" UpdateCommand="UPDATE TubeType SET Name=@Name, Description=@Description, Active=@Active WHERE Id=@Id">
            <InsertParameters>
        ...
        <asp:SqlDataSource ID="sdsPage" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM TubeType WHERE Id=@Id" UpdateCommand="UPDATE TubeType SET Active=@Active WHERE Id=@Id">
            <DeleteParameters>
                <asp:ControlParameter ControlID="lblId" Name="Id" PropertyName="Text" />
            </DeleteParameters>
            <UpdateParameters>

Partial Class Setting_Kit_Control
    Inherits Page
    ...
    Protected Sub btnDelete_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            publicCfg.InsertActivity(vUserId, Page.Title, "DELETE CONTROL TYPE. ID : " & lblId.Text)
    ...
    Protected Sub linkActive_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Dim active As String = row.Cells(3).Text
            ...
            publicCfg.InsertActivity(userId, Page.Title, "ACTIVE CONTROL TYPE. ID : " & lblId.Text)
    ...
    Private Sub BindData(SearchText As String)
        Try
            ...
            If Not SearchText = "" Then
                search = String.Format(" WHERE Id LIKE '%{0}%' OR Name LIKE '%{0}%' OR Description LIKE '%{0}%'", SearchText) '" WHERE Id LIKE '%" + SearchText + "%' OR Name LIKE '%" + SearchText + "%'" 
            End If

<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="Setting_Kit_Default" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.master" Debug="true" Title="Hardware Kit" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Hardware Kit</h3>
                            <div class="card-actions">
                                <asp:LinkButton runat="server" ID="btnAdd" CssClass="btn btn-primary "  OnClick="btnAdd_Click" >
                                    <i class="fa-regular fa-plus" style="margin-right: 0.3rem;"></i> Add Kit
                                </asp:LinkButton>

                                <button class="btn btn-secondary dropdown-toggle " data-bs-toggle="dropdown">
                                    <i class="fa-solid fa-ellipsis-vertical" style="margin-right: 0.3rem;"></i>
                                    Actions
                                </button>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <asp:Button runat="server" ID="btnBracketType" CssClass="dropdown-item" Text="Bracket Type" OnClick="btnBracketType_Click" />
                                    <asp:Button runat="server" ID="btnTubeType" CssClass="dropdown-item" Text="Tube Type" OnClick="btnTubeType_Click" />
                                    <asp:Button runat="server" ID="btnControlType" CssClass="dropdown-item" Text="Control Type" OnClick="btnControlType_Click" />
                                    <asp:Button runat="server" ID="btnColourType" CssClass="dropdown-item" Text="Colour Type" OnClick="btnColourType_Click" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="True" EmptyDataText="HARDWARE KIT DATA NOT FOUND :)" EmptyDataRowStyle-HorizontalAlign="Center" PageSize="20" PagerSettings-Position="TopAndBottom" OnPageIndexChanging="gvList_PageIndexChanging">
                                <RowStyle />
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="SoeId" HeaderText="SOE ID" />
                                    ...
                                    <asp:BoundField DataField="BlindName" HeaderText="Blind Name" />
                                    ...
                                    <asp:TemplateField ItemStyle-Width="200px">
                                        <ItemTemplate>
                                            <div class="float-end">
                                                ...
                                                <a href="#" runat="server" title="Delete" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalDelete" onclick='<%# String.Format("return showDelete(`{0}`, `{1}` , `{2}`);", Eval("Id").ToString(), Eval("SoeId").ToString(), Eval("Name").ToString()) %>' style="height: 2.3em; width: 2em;">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                  <li>
                                                    <asp:LinkButton runat="server" ID="linkDetail" CssClass="dropdown-item" Text="Detail" OnClick="linkDetail_Click">
                                                        <i class="bi bi-info-circle me-2 opacity-50"></i>Detail
                                                    </asp:LinkButton>
                                                  </li>
                                                  <li>
                                                    <a href="javascript:void(0);" runat="server" class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#modalDelete" onclick='<%# String.Format("return showDelete(`{0}`, `{1}` , `{2}`);", Eval("Id").ToString(), Eval("SoeId").ToString(), Eval("Name").ToString()) %>'>
    ...
    <script type="text/javascript">
        function showDelete(id, soeid, name) {
            var result = 'Are you sure you want to delete this hardware kit?';
            result += '<br /><br />';
            result += '<b>' + id.toUpperCase() + '</b>';
            result += '<br />';
            result += '<b>' + soeid.toUpperCase() + '</b>';
            result += '<br />';
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE HardwareKits SET Active=@Active WHERE Id=@Id" DeleteCommand="DELETE FROM HardwareKits WHERE Id=@Id">
            <UpdateParameters>

<%@ Page Title="Add Custom Discount" Language="VB"
MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Add.aspx.vb"
Inherits="Setting_CustomDiscount_Add" MaintainScrollPositionOnPostback="true"
Debug="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <div runat="server" visible="false">
    ...
    <asp:SqlDataSource
      ...
      InsertCommand="INSERT INTO CustomDiscounts VALUES (NEWID(), @DesignId, @BlindId, @BlindNo, @Name, @Type, @FieldName, @Formula, @Charge, @FromDate, @ToDate, @Description, @Active)"
    >
      <InsertParameters>

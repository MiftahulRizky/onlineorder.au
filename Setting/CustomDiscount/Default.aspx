<%@ Page Title="Custom Discount" Language="VB" MasterPageFile="~/Site.master"
AutoEventWireup="false" CodeFile="Default.aspx.vb"
Inherits="Setting_CustomDiscount_Default"
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
          ...
          <div class="card">
                ...
                <div class="text-secondary">
                  <div class="ms-2 d-inline-block">
                    <asp:DropDownList
                      ...
                      AutoPostBack="true"
                      OnSelectedIndexChanged="ddlDesignId_SelectedIndexChanged"
                    ></asp:DropDownList>
                  ...
                  <div class="ms-2 d-inline-block">
                    <asp:DropDownList
                      ...
                      CssClass="form-select "
                      AutoPostBack="true"
                      OnSelectedIndexChanged="ddlBlindId_SelectedIndexChanged"
                    ></asp:DropDownList>
            ...
            <div class="table-responsive">
              <asp:GridView
                ...
                EmptyDataText="CUSTOM DISCOUNT DATA NOT FOUND :)"
              ...
              >
                ...
                <Columns>
                  ...
                  <asp:BoundField DataField="Type" HeaderText="Discount Type" />
  ...
  <div runat="server" visible="false">
    ...
    <asp:SqlDataSource
      ...
      DeleteCommand="DELETE FROM CustomDiscounts"
    ></asp:SqlDataSource>

<%@ Page Title="Detail Custom Discount" Language="VB"
MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Detail.aspx.vb"
Inherits="Setting_CustomDiscount_Detail" MaintainScrollPositionOnPostback="true"
Debug="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                  <asp:DropDownList
                    ...
                    CssClass="form-select"
                  >
                    <asp:ListItem Value="Matrix" Text="MATRIX"></asp:ListItem>
  ...
  <div runat="server" visible="false">
    ...
    <asp:SqlDataSource
      ...
      UpdateCommand="UPDATE CustomDiscounts SET DesignId=@DesignId, BlindId=@BlindId, BlindNo=@BlindNo, Name=@Name, Type=@Type, FieldName=@FieldName, Formula=@Formula, Charge=@Charge, FromDate=@FromDate, ToDate=@ToDate, Description=@Description, Active=@Active WHERE Id=@Id"
    >
      <UpdateParameters>
        <asp:ControlParameter ControlID="lblId" Name="Id" PropertyName="Text" />
        <asp:ControlParameter
          ControlID="lblDesignId"
          Name="DesignId"
          PropertyName="Text"
        />
        <asp:ControlParameter
          ControlID="lblBlindId"
          Name="BlindId"
          PropertyName="Text"
        />
        <asp:ControlParameter
          ControlID="ddlBlindNo"
          Name="BlindNo"
        ...
        />
        <asp:ControlParameter
          ControlID="ddlFieldName"
          Name="FieldName"
          PropertyName="SelectedItem.Value"
        />
        <asp:ControlParameter
          ControlID="txtFormula"
          Name="Formula"
          PropertyName="Text"
        />
        <asp:ControlParameter

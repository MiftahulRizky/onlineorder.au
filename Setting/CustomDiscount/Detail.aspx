<%@ Page Title="Detail Custom Discount" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Detail.aspx.vb" Inherits="Setting_CustomDiscount_Detail" MaintainScrollPositionOnPostback="true" Debug="true"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE CustomDiscount SET DesignId=@DesignId, BlindId=@BlindId, BlindNo=@BlindNo, Name=@Name, FieldName=@FieldName, Formula=@Formula, Charge=@Charge, FromDate=@FromDate, ToDate=@ToDate, Description=@Description, Active=@Active WHERE Id=@Id">
            <UpdateParameters>

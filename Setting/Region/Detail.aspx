<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Detail.aspx.vb" Inherits="Setting_Region_Detail"MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Detail Region" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Detail Region / States</h3>
                        </div>
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE Regions SET AliasName=@AliasName, FullName=@FullName, Operator=@Operator, Description=@Description, Active=@Active WHERE Id=@Id">
            <UpdateParameters>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Design.aspx.vb"
Inherits="Setting_Product_Design" MasterPageFile="~/Site.Master"
MaintainScrollPositionOnPostback="true" Debug="true" Title="Design Type" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
          ...
          <div class="card">
            ...
            <div class="table-responsive">
              <asp:GridView
                ...
                EmptyDataText="DESIGN DATA NOT FOUND :)"
                PageSize="50"
                    ...
                    <ItemTemplate>
                      ...
                      <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a
                          ...
                          onclick='<%# String.Format("return showDelete(`{0}`);", Eval("Id").ToString()) %>'
                          visible="<%# VisibleAction() %>"
                          >Delete</a
                        >
                        <div
    ...
    >
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-4 row">
            <div class="col-12">
              <label class="form-label required">Page URL</label>
              <asp:TextBox
                runat="server"
                ID="txtPage"
                CssClass="form-control"
        ...
        <div class="modal-footer">
          ...
          <asp:Button
            ...
            Text="Submit"
            CssClass="btn btn-primary"
            OnClick="btnSubmitProcess_Click"
          />
        </div>
      </div>
    </div>
  ...
  <div runat="server" visible="false">
    ...
    <asp:Label runat="server" ID="lblNameOld"></asp:Label>
  </div>
</asp:Content>

...
Inherits="Setting_Design_Default" MasterPageFile="~/Site.master"
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
              ...
              >
                ...
                <Columns>
                  ...
                  <asp:TemplateField HeaderText="Name">
                    <ItemTemplate
                      ><%# IconActive(Eval("Active").ToString(),
  ...
  <div runat="server" visible="false">
    ...
    <asp:SqlDataSource
      ...
      DeleteCommand="DELETE FROM Designs WHERE Id=@Id"
      UpdateCommand="UPDATE Designs SET Active=@Active WHERE Id=@Id"
    >
      <DeleteParameters>

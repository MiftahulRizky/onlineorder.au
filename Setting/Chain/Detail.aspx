<%@ Page Language="VB" AutoEventWireup="true" CodeFile="Detail.aspx.vb" Inherits="Setting_Chain_Detail" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.master" Debug="true" Title="Detail Chain" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Detail Chain</h3>
                        </div>
    ...
    <div runat="server" visible="false">
        <asp:Label runat="server" ID="lblChainIdOri"></asp:Label>

        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" UpdateCommand="UPDATE Chains SET Name=@Name, Colour=@Colour, Length=@Length, Description=@Description, Active=@Active WHERE Id=@Id">
            <UpdateParameters>

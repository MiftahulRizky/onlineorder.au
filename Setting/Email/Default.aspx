<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_Email_Default" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.master" Debug="true" Title="Mail Configuration" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Mail Configuration</h3>
                            <div class="card-actions">
                                <asp:LinkButton runat="server" ID="btnAdd" CssClass="btn btn-primary " Text="Add Data" OnClick="btnAdd_Click" >
                                    <i class="fa-solid fa-plus" style="margin-right: 0.3rem;"></i> Add Data
                                </asp:LinkButton>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter card-table table-striped table-hover" AutoGenerateColumns="false" AllowPaging="True" PagerSettings-Position="TopAndBottom" EmptyDataText="MAIL CONFIGURATION DATA NOT FOUND :)" EmptyDataRowStyle-HorizontalAlign="Center" PageSize="50" OnPageIndexChanging="gvList_PageIndexChanging">
                                <RowStyle />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Application Name">
                                        <ItemTemplate>
                                            <%# IconActiveOnNames(Eval("Active").ToString(), Eval("AppName").ToString()) %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="200px">
                                        <ItemTemplate>
                                            <div class="float-end">
                                                ...
                                                <asp:LinkButton runat="server" title="Switc Activated" ID="linkActive" CssClass='<%# CssActive(Eval("Active")) %>' Text='<%# TextActive(Eval("Active").ToString()) %>' OnClick="linkActive_Click" style="height: 2.3em; width: 2em;"></asp:LinkButton> --%>
    ...
    <script type="text/javascript">
        ...
        function showDelete(id, name) {
            var result = 'Are you sure you want to delete this mail configuration?';
            result += '<br /><br />';
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource ID="sdsPage" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM MailConfiguration WHERE Id=@Id" UpdateCommand="UPDATE MailConfiguration SET Active=@Active WHERE Id=@Id">
            <DeleteParameters>

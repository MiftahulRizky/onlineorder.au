<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Add.aspx.vb" Inherits="Setting_Email_Add" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Add Mail Configuration" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Add Mail Configuration</h3>
                        </div>
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource runat="server" ID="sdsPage" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" InsertCommand="INSERT INTO MailConfiguration VALUES (NEWID(), @AppId, @Name, @Host, @Port, @EnableSsl, @Server, @Alias, @Account, @Password, @UseDefaultCredentials, @Subject, @To, @Cc, @Bcc, @Description, @Active)">
            <InsertParameters>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Setting_PriceGroup_Default" MasterPageFile="~/Site.master" MaintainScrollPositionOnPostback="true" Debug="true" Title="Price Group" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <asp:GridView runat="server" ID="gvList" CssClass="table table-vcenter table-striped table-hover card-table" AutoGenerateColumns="false" AllowPaging="True" EmptyDataText="PRICE GROUP DATA NOT FOUND ... :)" EmptyDataRowStyle-HorizontalAlign="Center" PagerSettings-Position="TopAndBottom" PageSize="25" OnPageIndexChanging="gvList_PageIndexChanging">
                                <RowStyle />
                                <Columns>
    ...
    <div runat="server" visible="false">
        ...
        <asp:SqlDataSource ID="sdsPage" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" DeleteCommand="DELETE FROM PricesGroup WHERE Id=@Id" UpdateCommand="UPDATE PricesGroup SET Active=@Active WHERE Id=@Id">
            <DeleteParameters>

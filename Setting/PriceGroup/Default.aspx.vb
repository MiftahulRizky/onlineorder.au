Partial Class Setting_PriceGroup_Default
    ...
    Private Sub BindDesign()
        ...
        Try
            ddlDesign.DataSource = publicCfg.GetListData("SELECT *, UPPER(Name) AS NameText FROM Designs WHERE Type IN ('Blinds', 'Door', 'Window', 'Additional', 'Surcharge', 'Door and Window') ORDER BY Name ASC")
